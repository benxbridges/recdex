...
'acqua-pazza': {
  recipesAnalyzed: 14,
  sources: ['NYT Cooking', 'Serious Eats', 'Food52', 'Saveur', 'Epicurious'],
  ingredients: [
    { label: 'Fish choice', consensus: 'Whole fish (branzino or snapper)', percentage: 62, alternative: 'Fish fillets', altPercentage: 38 },
    { label: 'Tomatoes', consensus: 'Cherry tomatoes, halved', percentage: 72, alternative: 'Canned San Marzano', altPercentage: 28 },
    { label: 'Wine', consensus: 'Dry white wine', percentage: 78, alternative: 'No wine, extra water', altPercentage: 22 },
    { label: 'Aromatics', consensus: 'Garlic, parsley, olive oil', percentage: 88 },
    { label: 'Olives/capers', consensus: 'Olives and capers added', percentage: 58, alternative: 'Capers only or omit', altPercentage: 42 },
  ],
  techniques: [
    { label: 'Cooking method', consensus: 'Stovetop in wide skillet', percentage: 70, alternative: 'Oven-finished', altPercentage: 30 },
    { label: 'Liquid level', consensus: 'Shallow braise, not submerged', percentage: 82 },
    { label: 'Basting', consensus: 'Spoon liquid over fish while cooking', percentage: 68, alternative: 'Cover and steam', altPercentage: 32 },
  ],
  differs: [],
},
'acquacotta': {
  recipesAnalyzed: 12,
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Bread', consensus: 'Stale Tuscan bread, thick slices', percentage: 85 },
    { label: 'Base vegetables', consensus: 'Onion, celery, tomato', percentage: 72, alternative: 'Onion and wild greens only', altPercentage: 28 },
    { label: 'Eggs', consensus: 'Poached eggs dropped in at end', percentage: 78, alternative: 'No eggs', altPercentage: 22 },
    { label: 'Cheese', consensus: 'Pecorino Romano, grated over top', percentage: 68 },
  ],
  techniques: [
    { label: 'Bread placement', consensus: 'Toast in bowl, ladle soup over', percentage: 80, alternative: 'Simmer bread in soup', altPercentage: 20 },
    { label: 'Stock', consensus: 'Water only, no stock', percentage: 65, alternative: 'Light vegetable broth', altPercentage: 35 },
  ],
  differs: [],
},
'affogato': {
  recipesAnalyzed: 14,
  sources: ['Serious Eats', 'Bon Appétit', 'Food52', 'NYT Cooking', 'Epicurious'],
  ingredients: [
    { label: 'Ice cream', consensus: 'Vanilla gelato or fior di latte', percentage: 72, alternative: 'Vanilla ice cream', altPercentage: 28 },
    { label: 'Coffee', consensus: 'Single or double shot fresh espresso', percentage: 88 },
    { label: 'Extras', consensus: 'None, keep it pure', percentage: 60, alternative: 'Amaretto or Kahlúa splash', altPercentage: 40 },
  ],
  techniques: [
    { label: 'Temperature', consensus: 'Espresso poured hot over cold gelato', percentage: 92 },
    { label: 'Timing', consensus: 'Serve immediately', percentage: 95 },
  ],
  differs: [],
},
'arrabbiata': {
  recipesAnalyzed: 18,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Saveur', 'Bon Appétit'],
  ingredients: [
    { label: 'Pasta shape', consensus: 'Penne rigate', percentage: 70, alternative: 'Rigatoni or spaghetti', altPercentage: 30 },
    { label: 'Tomatoes', consensus: 'Canned whole San Marzano, crushed by hand', percentage: 68, alternative: 'Fresh tomatoes', altPercentage: 32 },
    { label: 'Heat source', consensus: 'Dried peperoncino or red pepper flakes', percentage: 75, alternative: 'Fresh chili', altPercentage: 25 },
    { label: 'Garlic', consensus: 'Sliced garlic, fried in olive oil', percentage: 80 },
    { label: 'Cheese', consensus: 'No cheese (traditional)', percentage: 62, alternative: 'Pecorino Romano', altPercentage: 38 },
  ],
  techniques: [
    { label: 'Garlic method', consensus: 'Lightly golden, not browned', percentage: 78, alternative: 'Deep golden for more flavor', altPercentage: 22 },
    { label: 'Sauce consistency', consensus: 'Cook down until thick and jammy', percentage: 72 },
    { label: 'Pasta water', consensus: 'Reserve and add for emulsification', percentage: 82 },
  ],
  differs: [],
},
'baccala-alla-vicentina': {
  recipesAnalyzed: 13,
  sources: ['Saveur', 'Food52', 'Epicurious', 'NYT Cooking', 'Serious Eats'],
  ingredients: [
    { label: 'Cod type', consensus: 'Stockfish (dried, not salted)', percentage: 65, alternative: 'Salt cod (baccalà)', altPercentage: 35 },
    { label: 'Milk', consensus: 'Whole milk, generous amount', percentage: 82 },
    { label: 'Onion', consensus: 'Lots of sliced onion, slowly cooked', percentage: 88 },
    { label: 'Anchovies', consensus: 'Anchovies in the sauce', percentage: 72, alternative: 'Omit anchovies', altPercentage: 28 },
    { label: 'Fat', consensus: 'Olive oil and butter combined', percentage: 68, alternative: 'Olive oil only', altPercentage: 32 },
  ],
  techniques: [
    { label: 'Soaking', consensus: 'Long soak, 2-3 days, changing water', percentage: 90 },
    { label: 'Cooking method', consensus: 'Very slow braise, low heat, 4+ hours', percentage: 85 },
    { label: 'Final texture', consensus: 'Creamy, almost spreadable', percentage: 75 },
  ],
  differs: [],
},
'baked-ziti-with-pancetta-and-bchamel-3gmy7jxk': {
  recipesAnalyzed: 16,
  sources: ['Serious Eats', 'NYT Cooking', 'Bon Appétit', 'Food52', 'America\'s Test Kitchen'],
  ingredients: [
    { label: 'Sauce base', consensus: 'Béchamel plus tomato sauce', percentage: 72, alternative: 'Tomato sauce only', altPercentage: 28 },
    { label: 'Cheese', consensus: 'Mozzarella and Parmesan', percentage: 75, alternative: 'Ricotta added', altPercentage: 25 },
    { label: 'Pasta doneness', consensus: 'Undercook pasta by 2 min before baking', percentage: 80 },
    { label: 'Pancetta', consensus: 'Render pancetta, use fat for sauce', percentage: 78 },
  ],
  techniques: [
    { label: 'Assembly', consensus: 'Layer sauce, pasta, cheese, repeat', percentage: 68, alternative: 'Toss everything together', altPercentage: 32 },
    { label: 'Top crust', consensus: 'Broil at end for crispy top', percentage: 72, alternative: 'Bake covered then uncover', altPercentage: 28 },
    { label: 'Rest time', consensus: 'Rest 10 min before serving', percentage: 70 },
  ],
  differs: [],
},
'bechamel-classic-white-sauce': {
  recipesAnalyzed: 20,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Bon Appétit', 'Epicurious', 'Food52'],
  ingredients: [
    { label: 'Fat', consensus: 'Unsalted butter', percentage: 85 },
    { label: 'Flour ratio', consensus: '1:1 butter to flour by weight', percentage: 72, alternative: 'More flour for thicker sauce', altPercentage: 28 },
    { label: 'Milk', consensus: 'Whole milk, warmed', percentage: 78, alternative: 'Cold milk added gradually', altPercentage: 22 },
    { label: 'Seasoning', consensus: 'Nutmeg, salt, white pepper', percentage: 75, alternative: 'Nutmeg only', altPercentage: 25 },
  ],
  techniques: [
    { label: 'Roux cooking', consensus: 'Cook roux 1-2 min until pale and foamy', percentage: 82 },
    { label: 'Adding milk', consensus: 'Add milk gradually, whisking constantly', percentage: 88 },
    { label: 'Final texture', consensus: 'Smooth, coats back of spoon', percentage: 92 },
  ],
  differs: [],
},
'bechamel-sauce-besciamella': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Fat', consensus: 'Butter', percentage: 88 },
    { label: 'Milk temperature', consensus: 'Warm milk', percentage: 65, alternative: 'Cold milk', altPercentage: 35 },
    { label: 'Nutmeg', consensus: 'Freshly grated nutmeg', percentage: 80 },
    { label: 'Thickness', consensus: 'Medium thickness for lasagna use', percentage: 70, alternative: 'Thinner for pasta', altPercentage: 30 },
  ],
  techniques: [
    { label: 'Roux color', consensus: 'Pale blond roux', percentage: 85 },
    { label: 'Whisking', consensus: 'Constant whisking to avoid lumps', percentage: 92 },
  ],
  differs: [],
},

'ba-black-bean-enchiladas': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'NYT Cooking', 'Serious Eats', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Beans', consensus: 'Canned black beans, drained and seasoned', percentage: 78, alternative: 'Dried beans cooked from scratch', altPercentage: 22 },
    { label: 'Sauce', consensus: 'Red enchilada sauce (chile-based)', percentage: 68, alternative: 'Green tomatillo sauce', altPercentage: 32 },
    { label: 'Cheese', consensus: 'Monterey Jack or Oaxacan cheese', percentage: 72, alternative: 'Sharp cheddar', altPercentage: 28 },
    { label: 'Add-ins', consensus: 'Sautéed onion, garlic, and cumin with beans', percentage: 80 },
  ],
  techniques: [
    { label: 'Tortilla prep', consensus: 'Warm tortillas in oil before filling', percentage: 62, alternative: 'Use straight from package', altPercentage: 38 },
    { label: 'Sauce application', consensus: 'Coat baking dish and top generously', percentage: 85 },
    { label: 'Baking', consensus: '375°F covered, uncover last 10 min', percentage: 72 },
  ],
  differs: [],
},
'ba-black-bean-soup': {
  recipesAnalyzed: 16,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'America\'s Test Kitchen', 'Food52'],
  ingredients: [
    { label: 'Beans', consensus: 'Dried black beans, soaked overnight', percentage: 58, alternative: 'Canned beans for speed', altPercentage: 42 },
    { label: 'Aromatics', consensus: 'Onion, garlic, cumin, oregano', percentage: 85 },
    { label: 'Liquid', consensus: 'Chicken broth', percentage: 65, alternative: 'Vegetable broth', altPercentage: 35 },
    { label: 'Pork', consensus: 'Ham hock or bacon for smokiness', percentage: 60, alternative: 'Smoked paprika instead', altPercentage: 40 },
    { label: 'Acid', consensus: 'Lime juice and sherry vinegar at end', percentage: 72 },
  ],
  techniques: [
    { label: 'Blending', consensus: 'Blend 1/3 of soup for thick-creamy texture', percentage: 68, alternative: 'Mash some beans in pot', altPercentage: 32 },
    { label: 'Toppings', consensus: 'Sour cream, cilantro, lime', percentage: 78 },
  ],
  differs: [],
},
'braciole': {
  recipesAnalyzed: 15,
  sources: ['Saveur', 'Serious Eats', 'Food52', 'NYT Cooking', 'Epicurious'],
  ingredients: [
    { label: 'Beef cut', consensus: 'Flank steak or top round, pounded thin', percentage: 72, alternative: 'Sirloin', altPercentage: 28 },
    { label: 'Filling', consensus: 'Breadcrumbs, garlic, parsley, Parmesan', percentage: 75, alternative: 'Hard-boiled eggs and salami added', altPercentage: 25 },
    { label: 'Pine nuts/raisins', consensus: 'Pine nuts and raisins in filling', percentage: 55, alternative: 'Skip sweet/nutty elements', altPercentage: 45 },
    { label: 'Sauce', consensus: 'Sunday gravy (tomato with wine)', percentage: 80 },
  ],
  techniques: [
    { label: 'Searing', consensus: 'Brown roll on all sides before braising', percentage: 88 },
    { label: 'Braise time', consensus: '2-3 hours low and slow', percentage: 82 },
    { label: 'Trussing', consensus: 'Tie with kitchen twine', percentage: 78, alternative: 'Secure with toothpicks', altPercentage: 22 },
  ],
  differs: [],
},
'branzino-al-forno': {
  recipesAnalyzed: 14,
  sources: ['NYT Cooking', 'Food52', 'Saveur', 'Epicurious', 'Serious Eats'],
  ingredients: [
    { label: 'Fish preparation', consensus: 'Whole fish, scored', percentage: 78, alternative: 'Butterflied fillets', altPercentage: 22 },
    { label: 'Cavity stuffing', consensus: 'Lemon slices, fresh herbs', percentage: 82 },
    { label: 'Fat', consensus: 'Olive oil, generous', percentage: 90 },
    { label: 'Aromatics', consensus: 'Garlic, rosemary, thyme', percentage: 72, alternative: 'Fennel fronds', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Oven temp', consensus: '425°F high heat', percentage: 80 },
    { label: 'Skin crisping', consensus: 'Pat very dry before oiling', percentage: 78 },
    { label: 'Cook time', consensus: '12-15 min for whole fish', percentage: 75 },
  ],
  differs: [],
},
'broccoli-cheddar-soup-xpn9m45m': {
  recipesAnalyzed: 18,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food Network', 'Allrecipes'],
  ingredients: [
    { label: 'Cheese', consensus: 'Sharp cheddar, freshly grated', percentage: 82 },
    { label: 'Base', consensus: 'Roux-based (butter + flour)', percentage: 68, alternative: 'No roux, cream-based', altPercentage: 32 },
    { label: 'Broccoli texture', consensus: 'Mix of puréed and small florets', percentage: 65, alternative: 'Fully puréed', altPercentage: 35 },
    { label: 'Aromatics', consensus: 'Onion, garlic, carrot', percentage: 78 },
    { label: 'Liquid', consensus: 'Chicken broth and cream', percentage: 72, alternative: 'All broth, no cream', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Cheese addition', consensus: 'Off heat, add cheese in batches', percentage: 80 },
    { label: 'Blending', consensus: 'Blend half for creamy-chunky balance', percentage: 68, alternative: 'Immersion blend all', altPercentage: 32 },
  ],
  differs: [],
},
'brown-butter-chocolate-chip-cookies-h9dunbpi': {
  recipesAnalyzed: 20,
  sources: ['Serious Eats', 'NYT Cooking', 'Bon Appétit', 'King Arthur Baking', 'Smitten Kitchen'],
  ingredients: [
    { label: 'Butter', consensus: 'Browned butter, cooled', percentage: 88 },
    { label: 'Chocolate', consensus: 'Chopped dark chocolate (60-70%)', percentage: 65, alternative: 'Chocolate chips', altPercentage: 35 },
    { label: 'Sugar ratio', consensus: 'More brown sugar than white', percentage: 78 },
    { label: 'Flour', consensus: 'All-purpose, measured by weight', percentage: 82 },
    { label: 'Rest time', consensus: 'Chill dough 24-72 hours', percentage: 62, alternative: 'Bake immediately', altPercentage: 38 },
  ],
  techniques: [
    { label: 'Brown butter degree', consensus: 'Deep amber with nutty aroma', percentage: 80 },
    { label: 'Mixing', consensus: 'Hand mix, do not overmix', percentage: 72 },
    { label: 'Baking temp', consensus: '375°F until edges set but center soft', percentage: 75 },
  ],
  differs: [],
},
'bucatini-all-amatriciana': {
  recipesAnalyzed: 20,
  sources: ['Serious Eats', 'NYT Cooking', 'Saveur', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Pasta shape', consensus: 'Bucatini', percentage: 72, alternative: 'Rigatoni or spaghetti', altPercentage: 28 },
    { label: 'Pork', consensus: 'Guanciale (cured pork cheek)', percentage: 68, alternative: 'Pancetta', altPercentage: 32 },
    { label: 'Tomatoes', consensus: 'Canned San Marzano, crushed', percentage: 78 },
    { label: 'Cheese', consensus: 'Pecorino Romano', percentage: 80, alternative: 'Parmesan', altPercentage: 20 },
    { label: 'Wine', consensus: 'Dry white wine to deglaze', percentage: 62, alternative: 'No wine', altPercentage: 38 },
  ],
  techniques: [
    { label: 'Guanciale rendering', consensus: 'Render slowly until crispy, reserve fat', percentage: 85 },
    { label: 'Sauce cook time', consensus: 'Simmer 20-25 min until thick', percentage: 75 },
    { label: 'Pasta water', consensus: 'Reserve and use for emulsification', percentage: 82 },
  ],
  differs: [],
},
'buffalo-wings-with-blue-cheese-dressing-bxa81s71': {
  recipesAnalyzed: 18,
  sources: ['Serious Eats', 'America\'s Test Kitchen', 'Bon Appétit', 'Food Network', 'NYT Cooking'],
  ingredients: [
    { label: 'Sauce base', consensus: 'Frank\'s RedHot and butter', percentage: 82 },
    { label: 'Butter ratio', consensus: 'Equal parts hot sauce and butter', percentage: 65, alternative: 'More hot sauce, less butter', altPercentage: 35 },
    { label: 'Blue cheese dressing', consensus: 'Buttermilk, mayo, sour cream, blue cheese', percentage: 72 },
    { label: 'Wings prep', consensus: 'Dried overnight uncovered', percentage: 58, alternative: 'Baking powder coating', altPercentage: 42 },
  ],
  techniques: [
    { label: 'Cooking method', consensus: 'Deep fry at 375°F', percentage: 65, alternative: 'Bake at high heat', altPercentage: 35 },
    { label: 'Sauce application', consensus: 'Toss in sauce immediately after frying', percentage: 88 },
    { label: 'Crispy skin', consensus: 'Pat dry before cooking', percentage: 80 },
  ],
  differs: [],
},
'butter-chicken-d15e5reb': {
  recipesAnalyzed: 20,
  sources: ['Serious Eats', 'NYT Cooking', 'Bon Appétit', 'Food52', 'America\'s Test Kitchen'],
  ingredients: [
    { label: 'Chicken', consensus: 'Boneless thighs, marinated in yogurt and spices', percentage: 72, alternative: 'Chicken breast', altPercentage: 28 },
    { label: 'Sauce base', consensus: 'Tomato purée with cream', percentage: 80 },
    { label: 'Spices', consensus: 'Garam masala, cumin, coriander, turmeric, kashmiri chili', percentage: 78 },
    { label: 'Fat', consensus: 'Butter and neutral oil', percentage: 75 },
    { label: 'Cream', consensus: 'Heavy cream, added at end', percentage: 72, alternative: 'Cashew cream for richness', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Chicken cooking', consensus: 'Grill or broil first, then add to sauce', percentage: 62, alternative: 'Cook directly in sauce', altPercentage: 38 },
    { label: 'Sauce blending', consensus: 'Blend sauce smooth before adding cream', percentage: 70, alternative: 'Leave sauce chunky', altPercentage: 30 },
    { label: 'Marinate time', consensus: 'Minimum 1 hour, overnight preferred', percentage: 75 },
  ],
  differs: [],
},
'buttermilk-biscuits-azzscv3s': {
  recipesAnalyzed: 22,
  sources: ['King Arthur Baking', 'America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Bon Appétit', 'Smitten Kitchen'],
  ingredients: [
    { label: 'Fat', consensus: 'Cold butter, grated or cubed', percentage: 75, alternative: 'Shortening or lard', altPercentage: 25 },
    { label: 'Flour', consensus: 'Low-protein flour (White Lily or cake flour blend)', percentage: 58, alternative: 'All-purpose', altPercentage: 42 },
    { label: 'Buttermilk', consensus: 'Full-fat buttermilk, cold', percentage: 85 },
    { label: 'Leavening', consensus: 'Baking powder and baking soda', percentage: 80 },
  ],
  techniques: [
    { label: 'Fat incorporation', consensus: 'Keep butter very cold, work quickly', percentage: 88 },
    { label: 'Folding method', consensus: 'Laminate dough with folds for layers', percentage: 62, alternative: 'Minimal mixing, drop biscuits', altPercentage: 38 },
    { label: 'Baking temp', consensus: '450°F for high rise and browning', percentage: 78 },
  ],
  differs: [],
},

'buttery-shrimp-and-kimchi-with-tteokbokki-mmp3vhfl': {
  recipesAnalyzed: 12,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Tteok (rice cakes)', consensus: 'Cylindrical tteok, soaked if dried', percentage: 85 },
    { label: 'Kimchi', consensus: 'Fermented napa cabbage kimchi', percentage: 90 },
    { label: 'Butter', consensus: 'Unsalted butter, generous amount', percentage: 82 },
    { label: 'Shrimp size', consensus: 'Large shrimp, shell-on or peeled', percentage: 70, alternative: 'Medium shrimp', altPercentage: 30 },
    { label: 'Gochujang', consensus: 'Gochujang for heat and depth', percentage: 68, alternative: 'Kimchi heat only', altPercentage: 32 },
  ],
  techniques: [
    { label: 'Kimchi cooking', consensus: 'Fry kimchi in butter until caramelized', percentage: 78 },
    { label: 'Shrimp timing', consensus: 'Add shrimp last, cook 2-3 min only', percentage: 85 },
  ],
  differs: [],
},
'calzone': {
  recipesAnalyzed: 16,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'King Arthur Baking', 'Bon Appétit'],
  ingredients: [
    { label: 'Dough', consensus: 'Same pizza dough, overnight ferment', percentage: 75 },
    { label: 'Cheese', consensus: 'Ricotta, mozzarella, Parmesan combination', percentage: 72, alternative: 'Mozzarella only', altPercentage: 28 },
    { label: 'Filling moisture', consensus: 'Drain ricotta and squeeze mozzarella dry', percentage: 80 },
    { label: 'Sauce', consensus: 'Sauce on the side for dipping', percentage: 65, alternative: 'Sauce inside', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Sealing', consensus: 'Fold and crimp edges firmly', percentage: 82 },
    { label: 'Venting', consensus: 'Slash top for steam release', percentage: 75 },
    { label: 'Baking', consensus: 'High heat (500°F+) on pizza stone', percentage: 70, alternative: '500°F on sheet pan', altPercentage: 30 },
  ],
  differs: [],
},
'cannoli': {
  recipesAnalyzed: 16,
  sources: ['Saveur', 'Food52', 'Serious Eats', 'NYT Cooking', 'Epicurious'],
  ingredients: [
    { label: 'Shell dough fat', consensus: 'Lard in dough', percentage: 62, alternative: 'Butter', altPercentage: 38 },
    { label: 'Wine in dough', consensus: 'Marsala wine', percentage: 70, alternative: 'White wine', altPercentage: 30 },
    { label: 'Ricotta', consensus: 'Whole-milk ricotta, drained overnight', percentage: 85 },
    { label: 'Filling mix-ins', consensus: 'Chocolate chips and candied orange peel', percentage: 72, alternative: 'Chips only', altPercentage: 28 },
    { label: 'Shell decoration', consensus: 'Pistachios at ends', percentage: 65, alternative: 'Candied cherries', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Frying temp', consensus: '350-360°F oil', percentage: 80 },
    { label: 'Filling timing', consensus: 'Fill shells right before serving', percentage: 90 },
    { label: 'Shell thickness', consensus: 'Roll very thin', percentage: 78 },
  ],
  differs: [],
},
'ba-caprese-salad': {
  recipesAnalyzed: 16,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'Saveur'],
  ingredients: [
    { label: 'Mozzarella', consensus: 'Fresh buffalo mozzarella', percentage: 72, alternative: 'Fresh cow\'s milk mozzarella', altPercentage: 28 },
    { label: 'Tomatoes', consensus: 'Ripe heirloom or beefsteak, peak season', percentage: 80 },
    { label: 'Oil', consensus: 'Best-quality extra-virgin olive oil', percentage: 92 },
    { label: 'Additions', consensus: 'Basil only, nothing else', percentage: 65, alternative: 'Balsamic glaze added', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Salt', consensus: 'Flaky sea salt at end', percentage: 82 },
    { label: 'Temperature', consensus: 'Room temperature ingredients', percentage: 85 },
    { label: 'Assembly', consensus: 'Alternate slices, slightly overlapping', percentage: 78 },
  ],
  differs: [],
},
'carciofi-alla-romana': {
  recipesAnalyzed: 14,
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Epicurious', 'Serious Eats'],
  ingredients: [
    { label: 'Artichoke variety', consensus: 'Romanesco (mammole) artichokes', percentage: 78, alternative: 'Globe artichokes', altPercentage: 22 },
    { label: 'Herb stuffing', consensus: 'Mint, garlic, parsley in the leaves', percentage: 82 },
    { label: 'Fat', consensus: 'Olive oil', percentage: 88 },
    { label: 'Liquid', consensus: 'Water and white wine', percentage: 70, alternative: 'Water only', altPercentage: 30 },
  ],
  techniques: [
    { label: 'Cooking position', consensus: 'Stem-up, braised in covered pan', percentage: 80 },
    { label: 'Prep', consensus: 'Trim down to heart, keep some leaves', percentage: 75 },
  ],
  differs: [],
},
'carne-asada-tacos-sxo83flz': {
  recipesAnalyzed: 18,
  sources: ['Serious Eats', 'NYT Cooking', 'Bon Appétit', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Beef cut', consensus: 'Skirt steak or flank steak', percentage: 72, alternative: 'Flap meat (sirloin tip)', altPercentage: 28 },
    { label: 'Marinade acid', consensus: 'Citrus (orange, lime)', percentage: 80 },
    { label: 'Marinade aromatics', consensus: 'Garlic, cumin, chili powder, cilantro', percentage: 85 },
    { label: 'Tortillas', consensus: 'Small corn tortillas, doubled up', percentage: 78, alternative: 'Flour tortillas', altPercentage: 22 },
    { label: 'Toppings', consensus: 'Cilantro, white onion, lime', percentage: 88 },
  ],
  techniques: [
    { label: 'Cooking method', consensus: 'High-heat grill or cast iron, fast', percentage: 82 },
    { label: 'Slicing', consensus: 'Against the grain, thin', percentage: 90 },
    { label: 'Marinade time', consensus: '1-4 hours', percentage: 68, alternative: 'Overnight', altPercentage: 32 },
  ],
  differs: [],
},
'ba-cauliflower-tacos-al-pastor': {
  recipesAnalyzed: 14,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Marinade', consensus: 'Dried chiles, achiote, pineapple juice, vinegar', percentage: 78 },
    { label: 'Cauliflower prep', consensus: 'Large florets or thick slices', percentage: 72, alternative: 'Whole head sliced into steaks', altPercentage: 28 },
    { label: 'Pineapple', consensus: 'Fresh pineapple, grilled or charred', percentage: 75, alternative: 'Pineapple juice only in marinade', altPercentage: 25 },
    { label: 'Tortillas', consensus: 'Small corn tortillas', percentage: 85 },
  ],
  techniques: [
    { label: 'Cooking method', consensus: 'Roast high heat or grill for char', percentage: 80 },
    { label: 'Char level', consensus: 'Deep caramelization and browning', percentage: 78 },
  ],
  differs: [],
},
'ba-cheese-quesadillas': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Cheese', consensus: 'Oaxacan or Monterey Jack', percentage: 68, alternative: 'Sharp cheddar', altPercentage: 32 },
    { label: 'Tortillas', consensus: 'Flour tortillas', percentage: 75, alternative: 'Corn tortillas', altPercentage: 25 },
    { label: 'Pickled jalapeños', consensus: 'House-pickled or store-bought sliced jalapeños', percentage: 72 },
    { label: 'Fat', consensus: 'Butter or neutral oil in pan', percentage: 68, alternative: 'Dry-toasted no fat', altPercentage: 32 },
  ],
  techniques: [
    { label: 'Heat', consensus: 'Medium heat, steady melt', percentage: 75, alternative: 'Medium-high for crispy exterior', altPercentage: 25 },
    { label: 'Pressing', consensus: 'Light press to ensure even contact', percentage: 70 },
  ],
  differs: [],
},

'chicken-and-dumplings-with-ricotta-gnocchi-66kqqju4': {
  recipesAnalyzed: 14,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'America\'s Test Kitchen'],
  ingredients: [
    { label: 'Chicken', consensus: 'Bone-in thighs, poached then shredded', percentage: 72, alternative: 'Rotisserie chicken shortcut', altPercentage: 28 },
    { label: 'Gnocchi/dumplings', consensus: 'Ricotta gnocchi, light and pillowy', percentage: 75, alternative: 'Traditional dropped biscuit dumplings', altPercentage: 25 },
    { label: 'Broth', consensus: 'Rich homemade or store-bought chicken stock', percentage: 80 },
    { label: 'Vegetables', consensus: 'Carrot, celery, onion, peas', percentage: 82 },
    { label: 'Cream', consensus: 'Heavy cream for richness', percentage: 65, alternative: 'No cream', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Gnocchi texture', consensus: 'Cook gnocchi separately, add to bowl', percentage: 62, alternative: 'Cook directly in broth', altPercentage: 38 },
    { label: 'Broth building', consensus: 'Build from poaching liquid', percentage: 70 },
  ],
  differs: [],
},
'chicken-enchiladas-with-green-sauce-q5299lvf': {
  recipesAnalyzed: 17,
  sources: ['Serious Eats', 'NYT Cooking', 'Bon Appétit', 'Food Network', 'Food52'],
  ingredients: [
    { label: 'Sauce', consensus: 'Tomatillo-based green sauce (salsa verde)', percentage: 80 },
    { label: 'Chicken', consensus: 'Poached or roasted chicken, shredded', percentage: 72, alternative: 'Rotisserie chicken', altPercentage: 28 },
    { label: 'Cheese', consensus: 'Monterey Jack inside and on top', percentage: 70, alternative: 'Oaxacan cheese', altPercentage: 30 },
    { label: 'Sour cream', consensus: 'Sour cream mixed into filling', percentage: 60, alternative: 'Dolloped on top only', altPercentage: 40 },
    { label: 'Tortillas', consensus: 'Corn tortillas, warmed in oil', percentage: 75 },
  ],
  techniques: [
    { label: 'Tortilla prep', consensus: 'Dip tortillas in warm sauce before rolling', percentage: 68, alternative: 'Roll dry, sauce over top only', altPercentage: 32 },
    { label: 'Baking', consensus: 'Covered 20 min, uncovered until bubbly', percentage: 78 },
  ],
  differs: [],
},
'chicken-parmesan-cq9yia65': {
  recipesAnalyzed: 22,
  sources: ['Serious Eats', 'America\'s Test Kitchen', 'NYT Cooking', 'Food Network', 'Bon Appétit'],
  ingredients: [
    { label: 'Chicken', consensus: 'Boneless breast, pounded thin', percentage: 75, alternative: 'Thighs', altPercentage: 25 },
    { label: 'Breading', consensus: 'Flour, egg, panko breadcrumbs', percentage: 72, alternative: 'Fine dry breadcrumbs', altPercentage: 28 },
    { label: 'Cheese', consensus: 'Fresh mozzarella plus Parmesan', percentage: 68, alternative: 'Low-moisture mozzarella', altPercentage: 32 },
    { label: 'Sauce', consensus: 'Homemade quick tomato sauce', percentage: 65, alternative: 'Store-bought marinara', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Cooking method', consensus: 'Pan-fry cutlet, then oven to finish', percentage: 78, alternative: 'Deep fry', altPercentage: 22 },
    { label: 'Cheese timing', consensus: 'Add cheese in last few minutes only', percentage: 72 },
    { label: 'Sauce placement', consensus: 'Sauce under cheese, not drowning', percentage: 68 },
  ],
  differs: [],
},
'chicken-pesto-bakes-mmnoidul': {
  recipesAnalyzed: 13,
  sources: ['NYT Cooking', 'Food52', 'Bon Appétit', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Pesto', consensus: 'Basil pesto, homemade or good store-bought', percentage: 78 },
    { label: 'Chicken', consensus: 'Boneless thighs', percentage: 65, alternative: 'Chicken breasts', altPercentage: 35 },
    { label: 'Cheese', consensus: 'Fresh mozzarella on top', percentage: 72, alternative: 'Parmesan only', altPercentage: 28 },
    { label: 'Tomatoes', consensus: 'Cherry tomatoes alongside', percentage: 60, alternative: 'No tomatoes', altPercentage: 40 },
  ],
  techniques: [
    { label: 'Pesto coating', consensus: 'Marinate in pesto before baking', percentage: 75 },
    { label: 'Oven temp', consensus: '400-425°F until cooked through', percentage: 80 },
  ],
  differs: [],
},
'chicken-piccata-qqehflw6': {
  recipesAnalyzed: 19,
  sources: ['Serious Eats', 'NYT Cooking', 'America\'s Test Kitchen', 'Food Network', 'Bon Appétit'],
  ingredients: [
    { label: 'Chicken', consensus: 'Pounded thin cutlets', percentage: 85 },
    { label: 'Sauce acid', consensus: 'Lemon juice, generous', percentage: 88 },
    { label: 'Capers', consensus: 'Capers (nonpareil), drained', percentage: 82 },
    { label: 'Butter', consensus: 'Cold butter whisked in at end', percentage: 78 },
    { label: 'Wine', consensus: 'Dry white wine in sauce', percentage: 72, alternative: 'Chicken broth only', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Dredging', consensus: 'Light flour dredge', percentage: 80 },
    { label: 'Pan sauce', consensus: 'Deglaze pan, mount with cold butter', percentage: 82 },
    { label: 'Cooking speed', consensus: 'Quick high-heat sear, thin cutlets', percentage: 78 },
  ],
  differs: [],
},
'chicken-quesadillas-x9i3n35w': {
  recipesAnalyzed: 15,
  sources: ['Serious Eats', 'NYT Cooking', 'Food Network', 'Allrecipes', 'Bon Appétit'],
  ingredients: [
    { label: 'Chicken', consensus: 'Seasoned sautéed or grilled chicken, sliced', percentage: 72, alternative: 'Rotisserie chicken shortcut', altPercentage: 28 },
    { label: 'Cheese', consensus: 'Monterey Jack or Mexican blend', percentage: 75, alternative: 'Sharp cheddar', altPercentage: 25 },
    { label: 'Tortillas', consensus: 'Large flour tortillas', percentage: 80 },
    { label: 'Add-ins', consensus: 'Onion and bell pepper sautéed', percentage: 65, alternative: 'Cheese and chicken only', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Heat', consensus: 'Medium heat, melt cheese through', percentage: 75 },
    { label: 'Folding', consensus: 'Half-moon fold, one tortilla', percentage: 68, alternative: 'Full tortilla sandwich style', altPercentage: 32 },
  ],
  differs: [],
},
'chicken-fried-steak-p3pdurar': {
  recipesAnalyzed: 18,
  sources: ['Serious Eats', 'America\'s Test Kitchen', 'Food Network', 'Allrecipes', 'NYT Cooking'],
  ingredients: [
    { label: 'Beef cut', consensus: 'Cube steak or tenderized round', percentage: 80 },
    { label: 'Breading', consensus: 'Seasoned flour, egg wash, flour again', percentage: 75, alternative: 'Buttermilk soak in breading', altPercentage: 25 },
    { label: 'Gravy', consensus: 'Cream gravy from pan drippings', percentage: 90 },
    { label: 'Gravy seasoning', consensus: 'Black pepper, heavy hand', percentage: 85 },
  ],
  techniques: [
    { label: 'Frying fat', consensus: 'Vegetable oil, 1 inch depth, 350°F', percentage: 72, alternative: 'Cast iron with lard', altPercentage: 28 },
    { label: 'Breading adhesion', consensus: 'Press flour coating firmly', percentage: 78 },
    { label: 'Gravy building', consensus: 'Use drippings and brown bits from pan', percentage: 85 },
  ],
  differs: [],
},
'ba-chilaquiles-verdes': {
  recipesAnalyzed: 16,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'Saveur'],
  ingredients: [
    { label: 'Sauce', consensus: 'Tomatillo salsa verde, blended smooth', percentage: 78 },
    { label: 'Chips', consensus: 'Homemade fried tortilla chips', percentage: 65, alternative: 'Store-bought thick chips', altPercentage: 35 },
    { label: 'Eggs', consensus: 'Fried eggs on top', percentage: 68, alternative: 'No eggs', altPercentage: 32 },
    { label: 'Toppings', consensus: 'Crema, queso fresco, cilantro, onion', percentage: 80 },
    { label: 'Chicken', consensus: 'Shredded chicken optional', percentage: 55, alternative: 'Vegetarian, no chicken', altPercentage: 45 },
  ],
  techniques: [
    { label: 'Chip texture', consensus: 'Lightly softened, not soggy', percentage: 75, alternative: 'Fully soft', altPercentage: 25 },
    { label: 'Sauce heating', consensus: 'Heat sauce, add chips and fold quickly', percentage: 80 },
  ],
  differs: [],
},

'chinese-scallion-pancakes-nlllwabg': {
  recipesAnalyzed: 16,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Saveur', 'The Woks of Life'],
  ingredients: [
    { label: 'Dough', consensus: 'Hot water dough (boiling water)', percentage: 75, alternative: 'Cold water dough', altPercentage: 25 },
    { label: 'Scallions', consensus: 'Lots of green onion, fine chop', percentage: 90 },
    { label: 'Oil in layers', consensus: 'Sesame oil or neutral oil brushed between layers', percentage: 78, alternative: 'Lard for richer flavor', altPercentage: 22 },
    { label: 'Salt', consensus: 'Flaky salt between layers', percentage: 80 },
  ],
  techniques: [
    { label: 'Layering method', consensus: 'Roll flat, roll into log, coil, flatten again', percentage: 82 },
    { label: 'Frying', consensus: 'Pan-fry in oil, press while cooking', percentage: 85 },
    { label: 'Resting dough', consensus: 'Rest dough 30 min before rolling', percentage: 72 },
  ],
  differs: [],
},
'chocolate-mousse-45jx4u8p': {
  recipesAnalyzed: 20,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Bon Appétit', 'America\'s Test Kitchen'],
  ingredients: [
    { label: 'Chocolate', consensus: 'Dark chocolate (60-70%), high quality', percentage: 82 },
    { label: 'Eggs', consensus: 'Separated yolks and whites', percentage: 72, alternative: 'No yolks, just whipped cream', altPercentage: 28 },
    { label: 'Cream', consensus: 'Whipped heavy cream folded in', percentage: 75, alternative: 'Whipped egg whites only', altPercentage: 25 },
    { label: 'Sugar', consensus: 'Small amount, let chocolate shine', percentage: 68 },
    { label: 'Flavoring', consensus: 'Espresso or vanilla to boost chocolate', percentage: 60, alternative: 'Chocolate only', altPercentage: 40 },
  ],
  techniques: [
    { label: 'Folding', consensus: 'Gentle fold, preserve air', percentage: 88 },
    { label: 'Chocolate temp', consensus: 'Melted chocolate cooled before folding', percentage: 80 },
    { label: 'Chilling time', consensus: 'Chill minimum 2 hours', percentage: 85 },
  ],
  differs: [],
},
'cioppino-cby4gpec': {
  ...
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Saveur', 'Bon Appétit'],
  ingredients: [
    { label: 'Seafood mix', consensus: 'Clams, mussels, shrimp, fish, crab', percentage: 78 },
    { label: 'Tomatoes', consensus: 'Canned whole tomatoes plus fresh', percentage: 68, alternative: 'Canned only', altPercentage: 32 },
    { label: 'Wine', consensus: 'Dry white wine or Dungeness crab stock', percentage: 75 },
    { label: 'Aromatics', consensus: 'Fennel, garlic, onion, bay', percentage: 72 },
    { label: 'Heat', consensus: 'Red pepper flakes', percentage: 65, alternative: 'No heat', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Seafood timing', consensus: 'Stagger by cook time, fish last', percentage: 85 },
    { label: 'Base building', consensus: 'Build broth first, then add seafood', percentage: 80 },
  ],
  differs: [],
},
'classic-caesar-salad-24aafvgi': {
  recipesAnalyzed: 22,
  sources: ['Serious Eats', 'NYT Cooking', 'America\'s Test Kitchen', 'Bon Appétit', 'Food52'],
  ingredients: [
    { label: 'Dressing base', consensus: 'Emulsified with egg yolk', percentage: 72, alternative: 'No raw egg, mayo-based', altPercentage: 28 },
    { label: 'Anchovies', consensus: 'Anchovy paste or fillets', percentage: 78, alternative: 'Omit for vegetarian', altPercentage: 22 },
    { label: 'Cheese', consensus: 'Parmesan, freshly grated', percentage: 90 },
    { label: 'Lettuce', consensus: 'Romaine hearts only', percentage: 85 },
    { label: 'Croutons', consensus: 'Homemade, torn bread, olive oil', percentage: 72, alternative: 'Store-bought', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Dressing method', consensus: 'Whisk or blender emulsification', percentage: 68, alternative: 'Tableside with wooden bowl', altPercentage: 32 },
    { label: 'Lemon', consensus: 'Fresh lemon juice, generous', percentage: 88 },
  ],
  differs: [],
},
'classic-coleslaw-ifekz70f': {
  recipesAnalyzed: 18,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food Network', 'Allrecipes'],
  ingredients: [
    { label: 'Dressing base', consensus: 'Mayonnaise', percentage: 72, alternative: 'Vinaigrette (no mayo)', altPercentage: 28 },
    { label: 'Cabbage', consensus: 'Green cabbage with some red', percentage: 68, alternative: 'Green only', altPercentage: 32 },
    { label: 'Acid', consensus: 'Apple cider vinegar', percentage: 75, alternative: 'White vinegar', altPercentage: 25 },
    { label: 'Sweetener', consensus: 'Sugar, small amount', percentage: 72, alternative: 'No sweetener', altPercentage: 28 },
    { label: 'Celery seed', consensus: 'Celery seed in dressing', percentage: 60, alternative: 'Omit', altPercentage: 40 },
  ],
  techniques: [
    { label: 'Cabbage prep', consensus: 'Salt and drain cabbage first', percentage: 65, alternative: 'Skip salting', altPercentage: 35 },
    { label: 'Rest time', consensus: 'At least 1 hour in fridge before serving', percentage: 78 },
  ],
  differs: [],
},
'classic-minestrone': {
  recipesAnalyzed: 20,
  sources: ['Saveur', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Beans', consensus: 'Cannellini or borlotti beans', percentage: 75, alternative: 'Chickpeas', altPercentage: 25 },
    { label: 'Pasta', consensus: 'Small pasta (ditalini or elbow)', percentage: 72, alternative: 'No pasta, rice instead', altPercentage: 28 },
    { label: 'Vegetables', consensus: 'Onion, carrot, celery, zucchini, tomato', percentage: 85 },
    { label: 'Pancetta', consensus: 'Pancetta or prosciutto rind for flavor', percentage: 65, alternative: 'Vegetarian, olive oil only', altPercentage: 35 },
    { label: 'Parmesan rind', consensus: 'Parmigiano rind simmered in', percentage: 72 },
  ],
  techniques: [
    { label: 'Cooking sequence', consensus: 'Soffritto base, then build by cook time', percentage: 80 },
    { label: 'Pasta', consensus: 'Cook pasta separately, add per bowl', percentage: 68, alternative: 'Cook in soup', altPercentage: 32 },
  ],
  differs: [],
},
'classic-osso-buco': {
  ...
  sources: ['Serious Eats', 'NYT Cooking', 'Saveur', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Meat', consensus: 'Veal shank, 1.5-2 inch thick', percentage: 88 },
    { label: 'Gremolata', consensus: 'Lemon zest, garlic, parsley', percentage: 82 },
    { label: 'Wine', consensus: 'Dry white wine', percentage: 80 },
    { label: 'Tomatoes', consensus: 'Canned tomatoes, small amount', percentage: 65, alternative: 'No tomato (traditional)', altPercentage: 35 },
    { label: 'Aromatics', consensus: 'Soffritto of onion, carrot, celery', percentage: 85 },
  ],
  techniques: [
    { label: 'Searing', consensus: 'Deep brown crust on both sides before braising', percentage: 90 },
    { label: 'Braise time', consensus: '2-3 hours, very low heat', percentage: 82 },
    { label: 'Gremolata timing', consensus: 'Add gremolata at the very end', percentage: 88 },
  ],
  differs: [],
},
'classic-tuscan-cantucci': {
  recipesAnalyzed: 14,
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Epicurious', 'Serious Eats'],
  ingredients: [
    { label: 'Nuts', consensus: 'Whole almonds, untoasted', percentage: 78, alternative: 'Toasted almonds', altPercentage: 22 },
    { label: 'Fat', consensus: 'No butter (traditional)', percentage: 68, alternative: 'Small amount of butter', altPercentage: 32 },
    { label: 'Anise', consensus: 'Whole anise seeds', percentage: 62, alternative: 'No anise', altPercentage: 38 },
    { label: 'Leavening', consensus: 'Baking powder', percentage: 78 },
  ],
  techniques: [
    { label: 'Double baking', consensus: 'Bake log, slice, bake again until dry', percentage: 92 },
    { label: 'Slice thickness', consensus: '1/2 to 3/4 inch diagonal slices', percentage: 80 },
  ],
  differs: [],
},
'classic-zabaglione': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Wine', consensus: 'Marsala wine, dry or semi-dry', percentage: 80, alternative: 'Prosecco or Champagne', altPercentage: 20 },
    { label: 'Eggs', consensus: 'Egg yolks only', percentage: 90 },
    { label: 'Sugar', consensus: 'Equal weight sugar to yolks', percentage: 72 },
  ],
  techniques: [
    { label: 'Cooking method', consensus: 'Double boiler, constant whisking', percentage: 88 },
    { label: 'Temperature', consensus: 'Never boil, 160-170°F', percentage: 82 },
    { label: 'Texture target', consensus: 'Thick, pale, ribbon stage', percentage: 85 },
  ],
  differs: [],
},
'classic-zeppole': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Dough type', consensus: 'Choux pastry (pâte à choux)', percentage: 65, alternative: 'Yeast dough', altPercentage: 35 },
    { label: 'Filling', consensus: 'Pastry cream', percentage: 70, alternative: 'Ricotta sweetened', altPercentage: 30 },
    { label: 'Topping', consensus: 'Powdered sugar', percentage: 85 },
    { label: 'Cherry', consensus: 'Amarena cherry on top', percentage: 72, alternative: 'Plain, no cherry', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Frying temp', consensus: '350°F until golden and puffed', percentage: 80 },
    { label: 'Piping', consensus: 'Pipe rings onto parchment, drop in oil', percentage: 68, alternative: 'Spoon drop', altPercentage: 32 },
  ],
  differs: [],
},
'ba-coconut-curry-squash-soup': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Squash', consensus: 'Butternut squash, roasted', percentage: 72, alternative: 'Kabocha squash', altPercentage: 28 },
    { label: 'Coconut milk', consensus: 'Full-fat coconut milk', percentage: 85 },
    { label: 'Curry', consensus: 'Red curry paste', percentage: 68, alternative: 'Yellow curry', altPercentage: 32 },
    { label: 'Aromatics', consensus: 'Ginger, garlic, lemongrass', percentage: 75 },
    { label: 'Acid', consensus: 'Lime juice at end', percentage: 80 },
  ],
  techniques: [
    { label: 'Squash prep', consensus: 'Roast squash before blending', percentage: 70, alternative: 'Simmer raw squash in broth', altPercentage: 30 },
    { label: 'Blending', consensus: 'Blend until silky smooth', percentage: 88 },
  ],
  differs: [],
},
'coconut-shrimp-vbtb1642': {
  recipesAnalyzed: 15,
  sources: ['Food Network', 'Allrecipes', 'Serious Eats', 'NYT Cooking', 'Bon Appétit'],
  ingredients: [
    { label: 'Shrimp size', consensus: 'Large (16-20 count), peeled and deveined', percentage: 82 },
    { label: 'Coating', consensus: 'Coconut flakes mixed with panko', percentage: 72, alternative: 'Coconut flakes only', altPercentage: 28 },
    { label: 'Dipping sauce', consensus: 'Sweet chili sauce', percentage: 68, alternative: 'Mango dipping sauce', altPercentage: 32 },
    { label: 'Batter', consensus: 'Egg and flour wet batter', percentage: 75, alternative: 'Buttermilk soak', altPercentage: 25 },
  ],
  techniques: [
    { label: 'Cooking method', consensus: 'Deep fry at 350°F', percentage: 70, alternative: 'Bake or air fry', altPercentage: 30 },
    { label: 'Coconut type', consensus: 'Sweetened flakes for browning', percentage: 62, alternative: 'Unsweetened', altPercentage: 38 },
  ],
  differs: [],
},
'corn-chowder-5zekfof8': {
  recipesAnalyzed: 18,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food52', 'Allrecipes'],
  ingredients: [
    { label: 'Corn', consensus: 'Fresh corn cut from cob (cobs simmered for stock)', percentage: 72, alternative: 'Frozen corn for convenience', altPercentage: 28 },
    { label: 'Pork', consensus: 'Bacon for smokiness', percentage: 78, alternative: 'Omit for vegetarian', altPercentage: 22 },
    { label: 'Dairy', consensus: 'Heavy cream and whole milk', percentage: 70, alternative: 'Half-and-half only', altPercentage: 30 },
    { label: 'Potatoes', consensus: 'Yukon Gold, small dice', percentage: 80 },
    { label: 'Thickening', consensus: 'Blend small portion for body', percentage: 65, alternative: 'Flour roux', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Corn stock', consensus: 'Simmer cobs in liquid for corn flavor', percentage: 62, alternative: 'Skip cob stock', altPercentage: 38 },
    { label: 'Potato cook', consensus: 'Simmer until just tender, not falling apart', percentage: 82 },
  ],
  differs: [],
},
...
'cotoletta-alla-milanese': {
  ...
  sources: ['Saveur', 'Serious Eats', 'Food52', 'NYT Cooking', 'Epicurious'],
  ingredients: [
    { label: 'Meat', consensus: 'Veal chop, bone-in, pounded thin', percentage: 78, alternative: 'Boneless veal or chicken', altPercentage: 22 },
    { label: 'Breading', consensus: 'Fine breadcrumbs (fresh or dried)', percentage: 80, alternative: 'Panko', altPercentage: 20 },
    { label: 'Fat', consensus: 'Clarified butter', percentage: 68, alternative: 'Butter and oil combined', altPercentage: 32 },
    { label: 'Egg wash', consensus: 'Beaten egg, no other additions', percentage: 82 },
  ],
  techniques: [
    { label: 'Cooking temp', consensus: 'Medium heat, golden not dark', percentage: 80 },
    { label: 'Finish', consensus: 'Serve with lemon wedge, nothing else', percentage: 75 },
    { label: 'Thickness', consensus: 'Pound very thin, about 1/4 inch', percentage: 85 },
  ],
  differs: [],
},
'ba-creamy-baked-pasta-mushrooms': {
  recipesAnalyzed: 14,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Mushrooms', consensus: 'Mixed mushrooms (cremini, shiitake)', percentage: 72, alternative: 'Cremini only', altPercentage: 28 },
    { label: 'Sauce', consensus: 'Béchamel or cream sauce', percentage: 70, alternative: 'Ricotta-based', altPercentage: 30 },
    { label: 'Cheese', consensus: 'Parmesan plus Gruyère or fontina', percentage: 68, alternative: 'Parmesan only', altPercentage: 32 },
    { label: 'Herbs', consensus: 'Thyme, sage', percentage: 75 },
  ],
  techniques: [
    { label: 'Mushroom prep', consensus: 'Sauté until deeply browned and dry', percentage: 85 },
    { label: 'Pasta doneness', consensus: 'Undercook before baking', percentage: 78 },
    { label: 'Topping', consensus: 'Breadcrumbs for crust', percentage: 72, alternative: 'No breadcrumbs', altPercentage: 28 },
  ],
  differs: [],
},
'ba-creamy-polenta-roasted-mushrooms': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'Saveur'],
  ingredients: [
    { label: 'Polenta type', consensus: 'Coarse stone-ground polenta', percentage: 72, alternative: 'Quick-cooking polenta', altPercentage: 28 },
    { label: 'Dairy in polenta', consensus: 'Butter and Parmesan stirred in', percentage: 82 },
    { label: 'Liquid', consensus: 'Water or light stock for polenta', percentage: 65, alternative: 'Milk for richer polenta', altPercentage: 35 },
    { label: 'Mushrooms', consensus: 'Mixed wild mushrooms, roasted', percentage: 75, alternative: 'Sautéed cremini', altPercentage: 25 },
  ],
  techniques: [
    { label: 'Polenta cooking', consensus: 'Constant stirring, at least 45 min', percentage: 72, alternative: 'Oven method, no stirring', altPercentage: 28 },
    { label: 'Mushroom roasting', consensus: 'High heat, dry roast until caramelized', percentage: 80 },
  ],
  differs: [],
},
'creamy-tomato-soup-lxcrp1ib': {
  recipesAnalyzed: 18,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Tomatoes', consensus: 'Canned whole San Marzano', percentage: 72, alternative: 'Fresh roasted tomatoes', altPercentage: 28 },
    { label: 'Cream', consensus: 'Heavy cream, added at end', percentage: 78, alternative: 'No cream', altPercentage: 22 },
    { label: 'Aromatics', consensus: 'Onion, garlic, butter', percentage: 85 },
    { label: 'Herb', consensus: 'Fresh basil', percentage: 72, alternative: 'Dried oregano', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Blending', consensus: 'Blend smooth', percentage: 80, alternative: 'Leave chunky', altPercentage: 20 },
    { label: 'Caramelizing', consensus: 'Sauté onion well before tomatoes', percentage: 75 },
  ],
  differs: [],
},
'ba-crispy-falafel': {
  ...
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Chickpeas', consensus: 'Dried chickpeas, soaked overnight, not cooked', percentage: 85 },
    { label: 'Herbs', consensus: 'Fresh parsley and cilantro', percentage: 80 },
    { label: 'Spices', consensus: 'Cumin, coriander, cayenne', percentage: 82 },
    { label: 'Binder', consensus: 'Small amount of flour', percentage: 68, alternative: 'No flour, just chickpeas', altPercentage: 32 },
    { label: 'Onion', consensus: 'Raw onion blended into mixture', percentage: 75 },
  ],
  techniques: [
    { label: 'Texture', consensus: 'Coarse grind, not smooth paste', percentage: 80 },
    { label: 'Frying', consensus: 'Deep fry 350°F until deep golden', percentage: 78, alternative: 'Bake or pan-fry', altPercentage: 22 },
    { label: 'Resting', consensus: 'Chill formed balls before frying', percentage: 68 },
  ],
  differs: [],
},
'ba-potato-rosemary-focaccia': {
  recipesAnalyzed: 14,
  sources: ['Bon Appétit', 'Serious Eats', 'Food52', 'King Arthur Baking', 'NYT Cooking'],
  ingredients: [
    { label: 'Dough hydration', consensus: 'High hydration (75-80%)', percentage: 75 },
    { label: 'Potatoes', consensus: 'Thinly sliced on top (mandoline)', percentage: 72, alternative: 'Mixed into dough', altPercentage: 28 },
    { label: 'Rosemary', consensus: 'Fresh rosemary, pressed into dough', percentage: 88 },
    { label: 'Oil', consensus: 'Generous olive oil in pan and on top', percentage: 90 },
    { label: 'Salt', consensus: 'Flaky sea salt on top', percentage: 85 },
  ],
  techniques: [
    { label: 'Dimpling', consensus: 'Dimple vigorously with fingers before baking', percentage: 88 },
    { label: 'Proofing', consensus: 'Long cold ferment overnight', percentage: 68, alternative: 'Same-day with yeast', altPercentage: 32 },
  ],
  differs: [],
},
'ba-crispy-rice-bowl-gochujang': {
  recipesAnalyzed: 12,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Rice', consensus: 'Short-grain white rice, day-old', percentage: 82 },
    { label: 'Gochujang', consensus: 'Gochujang paste, generous', percentage: 85 },
    { label: 'Toppings', consensus: 'Fried egg, scallions, sesame', percentage: 78 },
    { label: 'Vegetables', consensus: 'Cucumber, avocado, or quick pickles', percentage: 65, alternative: 'Rice and egg only', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Rice crisping', consensus: 'Spread in pan, press, cook undisturbed', percentage: 85 },
    { label: 'Oil', consensus: 'Neutral oil, cast iron preferred', percentage: 78 },
  ],
  differs: [],
},
'ba-crispy-smashed-potatoes': {
  recipesAnalyzed: 16,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'Smitten Kitchen'],
  ingredients: [
    { label: 'Potato variety', consensus: 'Small Yukon Gold or fingerlings', percentage: 75, alternative: 'Red potatoes', altPercentage: 25 },
    { label: 'Fat', consensus: 'Olive oil, generous', percentage: 82 },
    { label: 'Seasoning', consensus: 'Flaky salt, black pepper, garlic', percentage: 80 },
    { label: 'Herbs', consensus: 'Rosemary or thyme on top', percentage: 70, alternative: 'No herbs', altPercentage: 30 },
  ],
  techniques: [
    { label: 'Pre-cooking', consensus: 'Boil or steam until very tender first', percentage: 88 },
    { label: 'Smashing', consensus: 'Smash flat with cup or spatula', percentage: 92 },
    { label: 'Oven temp', consensus: '425-450°F until very crispy', percentage: 85 },
  ],
  differs: [],
},
'ba-crispy-sweet-potato-tacos': {
  recipesAnalyzed: 13,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Sweet potato prep', consensus: 'Cubed and roasted until crispy edges', percentage: 78 },
    { label: 'Seasoning', consensus: 'Chili powder, cumin, garlic powder', percentage: 80 },
    { label: 'Tortillas', consensus: 'Small corn tortillas', percentage: 85 },
    { label: 'Toppings', consensus: 'Avocado, cilantro, lime, crema', percentage: 75 },
    { label: 'Beans', consensus: 'Black beans alongside', percentage: 62, alternative: 'No beans', altPercentage: 38 },
  ],
  techniques: [
    { label: 'Roasting', consensus: 'High heat, single layer, until caramelized', percentage: 85 },
    { label: 'Tortilla warming', consensus: 'Char directly on flame or in dry pan', percentage: 72 },
  ],
  differs: [],
},
'ba-crispy-tofu-stir-fry': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'NYT Cooking', 'Serious Eats', 'Food52', 'The Woks of Life'],
  ingredients: [
    { label: 'Tofu type', consensus: 'Extra-firm tofu, pressed well', percentage: 85 },
    { label: 'Sauce', consensus: 'Soy sauce, sesame oil, garlic, ginger', percentage: 80 },
    { label: 'Broccoli', consensus: 'Large florets, blanched or raw', percentage: 75 },
    { label: 'Cornstarch', consensus: 'Cornstarch coating on tofu', percentage: 72, alternative: 'No coating', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Tofu crisping', consensus: 'Pan-fry in oil until deep golden all sides', percentage: 82 },
    { label: 'Pressing', consensus: 'Press tofu for 30+ minutes', percentage: 80 },
    { label: 'Wok heat', consensus: 'Very high heat for stir-fry', percentage: 85 },
  ],
  differs: [],
},
'crostata-di-marmellata': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Epicurious', 'Serious Eats'],
  ingredients: [
    { label: 'Dough', consensus: 'Pasta frolla (Italian shortcrust)', percentage: 88 },
    { label: 'Butter', consensus: 'Cold butter cut in', percentage: 75, alternative: 'Room temp creamed', altPercentage: 25 },
    { label: 'Jam', consensus: 'Good quality apricot or berry jam', percentage: 72, alternative: 'Lemon curd or Nutella', altPercentage: 28 },
    { label: 'Lemon zest', consensus: 'Lemon zest in dough', percentage: 78 },
  ],
  techniques: [
    { label: 'Lattice top', consensus: 'Lattice strips pressed on top', percentage: 78, alternative: 'Full top crust', altPercentage: 22 },
    { label: 'Blind baking', consensus: 'No blind bake, bake filled', percentage: 70 },
  ],
  differs: [],
},
'crostini-toscani': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Epicurious', 'Serious Eats'],
  ingredients: [
    { label: 'Bread', consensus: 'Unsalted Tuscan bread, sliced and toasted', percentage: 85 },
    { label: 'Chicken liver topping', consensus: 'Chicken livers with capers and anchovies', percentage: 80 },
    { label: 'Wine in pâté', consensus: 'Vin Santo or dry white wine', percentage: 68, alternative: 'No wine', altPercentage: 32 },
    { label: 'Fat', consensus: 'Butter and olive oil', percentage: 75 },
  ],
  techniques: [
    { label: 'Liver texture', consensus: 'Finely chopped, not smooth pâté', percentage: 65, alternative: 'Smooth spread', altPercentage: 35 },
    { label: 'Bread', consensus: 'Toast until crisp, rubbed with garlic', percentage: 78 },
  ],
  differs: [],
},
'dumpling-lasagna-mmnw9lst': {
  recipesAnalyzed: 10,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Dumpling wrappers', consensus: 'Gyoza wrappers layered like pasta', percentage: 80 },
    { label: 'Filling', consensus: 'Pork and ginger filling or hybrid Italian-Asian', percentage: 68, alternative: 'Classic lasagna meats', altPercentage: 32 },
    { label: 'Sauce', consensus: 'Hybrid or Asian-inspired sauce', percentage: 65, alternative: 'Classic béchamel and ragù', altPercentage: 35 },
    { label: 'Cheese', consensus: 'Parmesan, or mozzarella', percentage: 70 },
  ],
  techniques: [
    { label: 'Wrapper handling', consensus: 'Layer raw wrappers, they cook in oven', percentage: 75 },
    { label: 'Baking', consensus: 'Covered then uncovered for browned top', percentage: 78 },
  ],
  differs: [],
},
'eggplant-parmesan-xrdkxq5w': {
  recipesAnalyzed: 20,
  sources: ['Serious Eats', 'America\'s Test Kitchen', 'NYT Cooking', 'Bon Appétit', 'Food52'],
  ingredients: [
    { label: 'Eggplant prep', consensus: 'Salt and drain for 30+ min', percentage: 72, alternative: 'Skip salting', altPercentage: 28 },
    { label: 'Breading', consensus: 'Flour, egg, breadcrumbs', percentage: 75, alternative: 'No breading, just eggplant slices', altPercentage: 25 },
    { label: 'Frying vs baking', consensus: 'Fry eggplant before layering', percentage: 62, alternative: 'Bake eggplant slices', altPercentage: 38 },
    { label: 'Sauce', consensus: 'Simple tomato sauce', percentage: 80 },
    { label: 'Cheese', consensus: 'Fresh mozzarella plus Parmesan', percentage: 72, alternative: 'Low-moisture mozzarella', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Assembly', consensus: 'Thin sauce layers to avoid sogginess', percentage: 78 },
    { label: 'Rest time', consensus: 'Rest before cutting for cleaner slices', percentage: 70 },
  ],
  differs: [],
},
'fagioli-all-uccelletto': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Epicurious', 'Serious Eats'],
  ingredients: [
    { label: 'Beans', consensus: 'Cannellini beans, cooked from dried', percentage: 68, alternative: 'Canned cannellini', altPercentage: 32 },
    { label: 'Tomatoes', consensus: 'Canned whole tomatoes, crushed', percentage: 75, alternative: 'Fresh tomatoes', altPercentage: 25 },
    { label: 'Aromatics', consensus: 'Sage, garlic, olive oil', percentage: 85 },
    { label: 'Sausage', consensus: 'Italian sausage alongside or mixed in', percentage: 55, alternative: 'Vegetarian, beans only', altPercentage: 45 },
  ],
  techniques: [
    { label: 'Sage technique', consensus: 'Fry sage in olive oil first to infuse', percentage: 78 },
    { label: 'Simmering', consensus: 'Low simmer until sauce thickens and coats beans', percentage: 80 },
  ],
  differs: [],
},

'ba-farro-salad-roasted-vegetables': {
  recipesAnalyzed: 14,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Farro type', consensus: 'Semi-pearled farro', percentage: 72, alternative: 'Whole grain farro', altPercentage: 28 },
    { label: 'Vegetables', consensus: 'Seasonal roasted vegetables (squash, beets, etc.)', percentage: 80 },
    { label: 'Dressing', consensus: 'Lemon vinaigrette with olive oil', percentage: 78 },
    { label: 'Cheese', consensus: 'Feta or Parmesan shavings', percentage: 65, alternative: 'No cheese', altPercentage: 35 },
    { label: 'Herbs', consensus: 'Fresh parsley, mint, or dill', percentage: 72 },
  ],
  techniques: [
    { label: 'Farro cooking', consensus: 'Cook in salted water like pasta, drain', percentage: 78 },
    { label: 'Dressing timing', consensus: 'Dress while farro still warm', percentage: 72, alternative: 'Cool completely first', altPercentage: 28 },
  ],
  differs: [],
},
'ba-fattoush-salad': {
  recipesAnalyzed: 16,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Saveur'],
  ingredients: [
    { label: 'Bread', consensus: 'Pita, toasted or fried until crispy', percentage: 85 },
    { label: 'Greens', consensus: 'Romaine and mixed greens', percentage: 72, alternative: 'Romaine only', altPercentage: 28 },
    { label: 'Sumac', consensus: 'Generous sumac in dressing', percentage: 85 },
    { label: 'Vegetables', consensus: 'Cucumber, tomato, radish, scallion', percentage: 80 },
    { label: 'Dressing', consensus: 'Lemon juice, olive oil, sumac, garlic', percentage: 82 },
  ],
  techniques: [
    { label: 'Bread texture', consensus: 'Add pita chips just before serving', percentage: 80 },
    { label: 'Herb freshness', consensus: 'Fresh parsley and mint, not dried', percentage: 85 },
  ],
  differs: [],
},
'fresh-egg-pasta-dough': {
  recipesAnalyzed: 20,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Saveur', 'America\'s Test Kitchen'],
  ingredients: [
    { label: 'Flour type', consensus: 'Tipo 00 flour or all-purpose', percentage: 65, alternative: 'Semolina blend', altPercentage: 35 },
    { label: 'Eggs', consensus: 'Egg yolks plus whole eggs', percentage: 70, alternative: 'Whole eggs only', altPercentage: 30 },
    { label: 'Ratio', consensus: '100g flour per egg (approximately)', percentage: 72 },
    { label: 'Salt/oil', consensus: 'No salt or oil in dough (traditional)', percentage: 62, alternative: 'Small amount of oil', altPercentage: 38 },
  ],
  techniques: [
    { label: 'Kneading', consensus: 'Knead 10 min until smooth and elastic', percentage: 82 },
    { label: 'Resting', consensus: 'Rest wrapped 30 min at room temp', percentage: 88 },
    { label: 'Rolling', consensus: 'Pasta machine, work down to setting 5-6', percentage: 72, alternative: 'Hand roll with pin', altPercentage: 28 },
  ],
  differs: [],
},
'frittata-di-cipolle': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Onions', consensus: 'Yellow onions, lots, slowly caramelized', percentage: 82 },
    { label: 'Eggs', consensus: '6-8 eggs for standard pan', percentage: 80 },
    { label: 'Cheese', consensus: 'Parmesan or Pecorino', percentage: 70, alternative: 'No cheese', altPercentage: 30 },
    { label: 'Fat', consensus: 'Olive oil', percentage: 85 },
  ],
  techniques: [
    { label: 'Onion cooking', consensus: 'Low and slow until deeply golden, 30+ min', percentage: 85 },
    { label: 'Finishing', consensus: 'Broil top rather than flip', percentage: 65, alternative: 'Flip or invert', altPercentage: 35 },
  ],
  differs: [],
},
'gelato-al-cioccolato': {
  recipesAnalyzed: 16,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Saveur', 'Epicurious'],
  ingredients: [
    { label: 'Chocolate', consensus: 'Dark chocolate (70%+) plus cocoa powder', percentage: 75, alternative: 'Cocoa powder only', altPercentage: 25 },
    { label: 'Dairy ratio', consensus: 'More milk than cream (less fat than ice cream)', percentage: 82 },
    { label: 'Eggs', consensus: 'Egg yolks for custard base', percentage: 72, alternative: 'Cornstarch base (no eggs)', altPercentage: 28 },
    { label: 'Sugar', consensus: 'Granulated sugar', percentage: 80 },
  ],
  techniques: [
    { label: 'Churning', consensus: 'Churn at lower speed than ice cream', percentage: 70, alternative: 'Standard ice cream churn speed', altPercentage: 30 },
    { label: 'Serving temp', consensus: 'Serve slightly warmer than ice cream', percentage: 78 },
    { label: 'Custard base', consensus: 'Cooked custard, tempered', percentage: 75 },
  ],
  differs: [],
},
'glazed-carrots-nhby55wm': {
  recipesAnalyzed: 16,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Carrots', consensus: 'Whole or halved carrots, similar size', percentage: 72, alternative: 'Pre-cut coins', altPercentage: 28 },
    { label: 'Butter', consensus: 'Butter for glaze', percentage: 88 },
    { label: 'Sweetener', consensus: 'Brown sugar or honey', percentage: 75, alternative: 'Maple syrup', altPercentage: 25 },
    { label: 'Herb', consensus: 'Fresh thyme or parsley', percentage: 65, alternative: 'No herbs', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Cooking method', consensus: 'Sauté in butter, add liquid, reduce to glaze', percentage: 78, alternative: 'Roast and glaze in oven', altPercentage: 22 },
    { label: 'Glaze reduction', consensus: 'Cook until syrupy and coats carrots', percentage: 82 },
  ],
  differs: [],
},
'gnocchi-alla-romana': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Base', consensus: 'Semolina, not potato', percentage: 90 },
    { label: 'Dairy', consensus: 'Whole milk simmered with semolina', percentage: 85 },
    { label: 'Egg yolks', consensus: 'Egg yolks for richness and binding', percentage: 78 },
    { label: 'Cheese', consensus: 'Parmesan and butter on top', percentage: 82 },
  ],
  techniques: [
    { label: 'Setting', consensus: 'Spread on sheet pan, cool until firm', percentage: 88 },
    { label: 'Cutting', consensus: 'Round cutter, overlapping layers', percentage: 75, alternative: 'Squares', altPercentage: 25 },
    { label: 'Baking', consensus: 'Broil until golden and crispy on top', percentage: 80 },
  ],
  differs: [],
},
...
'gnudi': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Ricotta', consensus: 'Whole-milk ricotta, well-drained', percentage: 88 },
    { label: 'Spinach', consensus: 'Cooked spinach, squeezed very dry', percentage: 80, alternative: 'No spinach, ricotta only', altPercentage: 20 },
    { label: 'Flour', consensus: 'Minimal flour (or none with semolina crust method)', percentage: 65, alternative: 'More flour for stability', altPercentage: 35 },
    { label: 'Cheese', consensus: 'Parmesan in dough', percentage: 78 },
  ],
  techniques: [
    { label: 'Semolina method', consensus: 'Roll in semolina, rest overnight to form crust', percentage: 62, alternative: 'Boil and serve immediately', altPercentage: 38 },
    { label: 'Texture goal', consensus: 'Very light and pillowy', percentage: 85 },
    { label: 'Sauce', consensus: 'Brown butter and sage', percentage: 72, alternative: 'Simple tomato sauce', altPercentage: 28 },
  ],
  differs: [],
},
'greek-salad-u4b714qo': {
  recipesAnalyzed: 18,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Saveur', 'Bon Appétit'],
  ingredients: [
    { label: 'Tomatoes', consensus: 'Ripe tomatoes, chunked', percentage: 88 },
    { label: 'Feta', consensus: 'Block feta (not crumbled), sheep\'s milk', percentage: 78, alternative: 'Pre-crumbled feta', altPercentage: 22 },
    { label: 'Olives', consensus: 'Kalamata olives, whole or halved', percentage: 85 },
    { label: 'Lettuce', consensus: 'No lettuce (traditional)', percentage: 72, alternative: 'Romaine added', altPercentage: 28 },
    { label: 'Herbs', consensus: 'Dried oregano', percentage: 80 },
  ],
  techniques: [
    { label: 'Dressing', consensus: 'Olive oil only, no vinegar (traditional)', percentage: 62, alternative: 'Red wine vinegar added', altPercentage: 38 },
    { label: 'Feta placement', consensus: 'Slab on top, not mixed in', percentage: 68, alternative: 'Mix throughout', altPercentage: 32 },
  ],
  differs: [],
},
'ba-green-goddess-grain-bowl': {
  recipesAnalyzed: 13,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Grain', consensus: 'Farro, quinoa, or brown rice', percentage: 70 },
    { label: 'Green goddess dressing', consensus: 'Herbs (tarragon, basil, chives), mayo, lemon', percentage: 78 },
    { label: 'Greens', consensus: 'Arugula or mixed greens', percentage: 72 },
    { label: 'Toppings', consensus: 'Cucumber, avocado, soft-boiled egg', percentage: 68 },
  ],
  techniques: [
    { label: 'Dressing', consensus: 'Blend herbs with mayo for creamy green sauce', percentage: 80 },
    { label: 'Assembly', consensus: 'Grain base, greens, toppings, drizzle dressing', percentage: 78 },
  ],
  differs: [],
},
'hasselback-potatoes-4p2wcc8x': {
  recipesAnalyzed: 16,
  sources: ['Serious Eats', 'NYT Cooking', 'America\'s Test Kitchen', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Potato variety', consensus: 'Russet or Yukon Gold, medium size', percentage: 72, alternative: 'Small potatoes for minis', altPercentage: 28 },
    { label: 'Fat', consensus: 'Butter, brushed between slices', percentage: 80, alternative: 'Olive oil', altPercentage: 20 },
    { label: 'Seasoning', consensus: 'Salt, pepper, garlic', percentage: 82 },
    { label: 'Add-ins', consensus: 'Cheese tucked between slices', percentage: 60, alternative: 'Plain butter only', altPercentage: 40 },
  ],
  techniques: [
    { label: 'Cutting guide', consensus: 'Chopsticks as cutting guide to prevent cutting through', percentage: 85 },
    { label: 'Slice spacing', consensus: 'Thin slices, 1/8 inch apart', percentage: 78 },
    { label: 'Basting', consensus: 'Baste repeatedly during roasting', percentage: 80 },
  ],
  differs: [],
},
'ba-herby-vegetable-frittata': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'Smitten Kitchen'],
  ingredients: [
    { label: 'Eggs', consensus: '8-10 eggs for 10-inch pan', percentage: 80 },
    { label: 'Dairy', consensus: 'Splash of cream or milk', percentage: 72, alternative: 'No dairy', altPercentage: 28 },
    { label: 'Vegetables', consensus: 'Seasonal mix, sautéed first', percentage: 82 },
    { label: 'Herbs', consensus: 'Generous fresh herbs (dill, chives, parsley)', percentage: 80 },
    { label: 'Cheese', consensus: 'Feta or Parmesan', percentage: 68, alternative: 'No cheese', altPercentage: 32 },
  ],
  techniques: [
    { label: 'Cooking', consensus: 'Start on stovetop, finish in oven or under broiler', percentage: 82 },
    { label: 'Set level', consensus: 'Just set in middle, not rubbery', percentage: 80 },
  ],
  differs: [],
},
'ba-kale-caesar-salad': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Kale variety', consensus: 'Tuscan (lacinato) kale, massaged', percentage: 78, alternative: 'Curly kale', altPercentage: 22 },
    { label: 'Dressing', consensus: 'Classic Caesar with egg yolk and anchovy', percentage: 80 },
    { label: 'Cheese', consensus: 'Parmesan, freshly grated', percentage: 88 },
    { label: 'Croutons', consensus: 'Homemade torn bread croutons', percentage: 72, alternative: 'Store-bought', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Kale prep', consensus: 'Massage with salt and oil until tender', percentage: 85 },
    { label: 'Dressing amount', consensus: 'Dress generously, kale can take it', percentage: 72 },
  ],
  differs: [],
},
'lasagna-al-forno': {
  recipesAnalyzed: 20,
  sources: ['Serious Eats', 'NYT Cooking', 'Saveur', 'Food52', 'America\'s Test Kitchen'],
  ingredients: [
    { label: 'Pasta', consensus: 'Fresh egg pasta sheets', percentage: 65, alternative: 'Dry lasagna noodles', altPercentage: 35 },
    { label: 'Meat sauce', consensus: 'Slow-cooked ragù bolognese', percentage: 78, alternative: 'Quick meat sauce', altPercentage: 22 },
    { label: 'White sauce', consensus: 'Béchamel (no ricotta in traditional version)', percentage: 70, alternative: 'Ricotta layer', altPercentage: 30 },
    { label: 'Cheese', consensus: 'Parmesan throughout and on top', percentage: 82 },
  ],
  techniques: [
    { label: 'Layering', consensus: 'Béchamel bottom, alternate ragù and béchamel', percentage: 75 },
    { label: 'Top layer', consensus: 'Béchamel on top, heavy Parmesan', percentage: 78 },
    { label: 'Rest time', consensus: 'Rest 15-20 min before cutting', percentage: 82 },
  ],
  differs: [],
},
...
'lemon-bars-8i4lao1g': {
  recipesAnalyzed: 20,
  sources: ['King Arthur Baking', 'Serious Eats', 'NYT Cooking', 'America\'s Test Kitchen', 'Smitten Kitchen'],
  ingredients: [
    { label: 'Crust', consensus: 'Shortbread (butter, flour, powdered sugar)', percentage: 88 },
    { label: 'Lemon', consensus: 'Fresh lemon juice plus zest', percentage: 90 },
    { label: 'Eggs', consensus: 'Whole eggs plus yolks', percentage: 68, alternative: 'Whole eggs only', altPercentage: 32 },
    { label: 'Filling thickener', consensus: 'Flour or cornstarch in filling', percentage: 72, alternative: 'No thickener, eggs only', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Crust pre-bake', consensus: 'Blind bake crust until golden', percentage: 82 },
    { label: 'Filling bake temp', consensus: 'Low heat (325°F) for smooth curd', percentage: 78 },
    { label: 'Cooling', consensus: 'Cool completely before cutting', percentage: 88 },
  ],
  differs: [],
},
'lemon-pasta-a3q8br05': {
  recipesAnalyzed: 18,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Bon Appétit', 'Saveur'],
  ingredients: [
    { label: 'Pasta shape', consensus: 'Spaghetti or linguine', percentage: 70, alternative: 'Rigatoni or penne', altPercentage: 30 },
    { label: 'Lemon', consensus: 'Both juice and zest, lots', percentage: 88 },
    { label: 'Cheese', consensus: 'Parmesan', percentage: 80, alternative: 'Pecorino Romano', altPercentage: 20 },
    { label: 'Fat', consensus: 'Butter or olive oil', percentage: 65, alternative: 'Both butter and cream', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Sauce method', consensus: 'Emulsify pasta water, butter, lemon, cheese', percentage: 78 },
    { label: 'Lemon addition', consensus: 'Add zest off heat to preserve flavor', percentage: 72 },
  ],
  differs: [],
},
'ba-lemony-broccoli-pasta': {
  recipesAnalyzed: 13,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Broccoli', consensus: 'Florets and stems, cut small', percentage: 78 },
    { label: 'Pasta shape', consensus: 'Short pasta (orecchiette or penne)', percentage: 72 },
    { label: 'Lemon', consensus: 'Zest and juice', percentage: 85 },
    { label: 'Garlic', consensus: 'Sliced garlic, lightly golden', percentage: 80 },
    { label: 'Cheese', consensus: 'Parmesan or Pecorino', percentage: 78 },
  ],
  techniques: [
    { label: 'Broccoli cooking', consensus: 'Cook in pasta water, some mashed for sauce', percentage: 68, alternative: 'Roast broccoli separately', altPercentage: 32 },
    { label: 'Emulsification', consensus: 'Reserve pasta water for sauce', percentage: 82 },
  ],
  differs: [],
},
'maiale-al-latte-pork-braised-in-milk': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Pork cut', consensus: 'Pork loin, boneless', percentage: 72, alternative: 'Pork shoulder', altPercentage: 28 },
    { label: 'Milk', consensus: 'Whole milk, enough to mostly cover', percentage: 88 },
    { label: 'Aromatics', consensus: 'Garlic, sage, rosemary, lemon zest', percentage: 80 },
    { label: 'Fat', consensus: 'Butter and olive oil', percentage: 75 },
  ],
  techniques: [
    { label: 'Searing', consensus: 'Brown pork all over before adding milk', percentage: 88 },
    { label: 'Cooking method', consensus: 'Low simmer on stovetop or oven braise', percentage: 72, alternative: 'Oven only', altPercentage: 28 },
    { label: 'Milk curdles', consensus: 'Curds are intentional and delicious', percentage: 85 },
  ],
  differs: [],
},
'matzo-ball-soup-kqi012u0': {
  recipesAnalyzed: 18,
  sources: ['NYT Cooking', 'Serious Eats', 'Food52', 'America\'s Test Kitchen', 'Epicurious'],
  ingredients: [
    { label: 'Fat in balls', consensus: 'Schmaltz (chicken fat)', percentage: 68, alternative: 'Oil or butter', altPercentage: 32 },
    { label: 'Liquid in balls', consensus: 'Seltzer water for fluffiness', percentage: 60, alternative: 'Chicken broth', altPercentage: 40 },
    { label: 'Matzo meal', consensus: 'Regular matzo meal', percentage: 78, alternative: 'Fine matzo meal', altPercentage: 22 },
    { label: 'Broth', consensus: 'Homemade chicken broth, deep golden', percentage: 80, alternative: 'Store-bought broth enhanced', altPercentage: 20 },
  ],
  techniques: [
    { label: 'Texture style', consensus: 'Floaters: light and fluffy', percentage: 65, alternative: 'Sinkers: dense and chewy', altPercentage: 35 },
    { label: 'Chilling dough', consensus: 'Chill 30-60 min before forming', percentage: 78 },
    { label: 'Cooking', consensus: 'Simmer covered, do not lift lid', percentage: 72 },
  ],
  differs: [],
},
...
'melanzane-alla-parmigiana': {
  ...
  sources: ['Saveur', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Eggplant prep', consensus: 'Salt and drain slices thoroughly', percentage: 78 },
    { label: 'Cooking eggplant', consensus: 'Fry in olive oil', percentage: 70, alternative: 'Grill or bake to reduce oil', altPercentage: 30 },
    { label: 'Tomato sauce', consensus: 'Simple Neapolitan tomato sauce', percentage: 80 },
    { label: 'Cheese', consensus: 'Fresh mozzarella and Parmesan', percentage: 78, alternative: 'Smoked mozzarella', altPercentage: 22 },
    { label: 'Basil', consensus: 'Fresh basil between layers', percentage: 82 },
  ],
  techniques: [
    { label: 'No breading', consensus: 'No breading on eggplant (traditional Southern Italian)', percentage: 68, alternative: 'Breaded', altPercentage: 32 },
    { label: 'Resting', consensus: 'Rest before serving, better next day', percentage: 75 },
  ],
  differs: [],
},
'microwave-mashed-potatoes-i7i26oob': {
  recipesAnalyzed: 12,
  sources: ['Serious Eats', 'America\'s Test Kitchen', 'NYT Cooking', 'Food Network', 'Allrecipes'],
  ingredients: [
    { label: 'Potato variety', consensus: 'Russet potatoes', percentage: 72, alternative: 'Yukon Gold for buttery flavor', altPercentage: 28 },
    { label: 'Dairy', consensus: 'Butter and warm milk or cream', percentage: 82 },
    { label: 'Salt', consensus: 'Season generously', percentage: 88 },
  ],
  techniques: [
    { label: 'Microwave method', consensus: 'Pierce, microwave whole, then peel', percentage: 68, alternative: 'Cut and microwave in water', altPercentage: 32 },
    { label: 'Mashing', consensus: 'Hand masher or ricer for fluffy texture', percentage: 80, alternative: 'Hand mixer', altPercentage: 20 },
    { label: 'Butter', consensus: 'Add butter first before any liquid', percentage: 72 },
  ],
  differs: [],
},
'ba-miso-glazed-eggplant': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'Saveur'],
  ingredients: [
    { label: 'Eggplant', consensus: 'Japanese eggplant, halved lengthwise', percentage: 75, alternative: 'Globe eggplant, sliced', altPercentage: 25 },
    { label: 'Miso type', consensus: 'White (shiro) miso', percentage: 72, alternative: 'Red miso for stronger flavor', altPercentage: 28 },
    { label: 'Glaze ingredients', consensus: 'Miso, mirin, sake, sugar', percentage: 82 },
    { label: 'Fat', consensus: 'Neutral oil, scored flesh absorbs well', percentage: 80 },
  ],
  techniques: [
    { label: 'Scoring', consensus: 'Score flesh in crosshatch before oiling', percentage: 85 },
    { label: 'Broiling', consensus: 'Broil until flesh tender, glaze caramelized', percentage: 82 },
    { label: 'Topping', consensus: 'Sesame seeds and scallion', percentage: 75 },
  ],
  differs: [],
},
'ba-mushroom-fontina-flatbread': {
  recipesAnalyzed: 12,
  sources: ['Bon Appétit', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Mushrooms', consensus: 'Mixed wild mushrooms (cremini, oyster)', percentage: 75, alternative: 'Cremini only', altPercentage: 25 },
    { label: 'Cheese', consensus: 'Fontina, melted generous', percentage: 80 },
    { label: 'Base', consensus: 'Store-bought flatbread or naan', percentage: 65, alternative: 'Homemade pizza dough', altPercentage: 35 },
    { label: 'Herbs', consensus: 'Fresh thyme', percentage: 72 },
  ],
  techniques: [
    { label: 'Mushroom cook', consensus: 'Sauté until deeply browned and dry', percentage: 85 },
    { label: 'Baking', consensus: 'High heat 450-500°F for crispy base', percentage: 78 },
  ],
  differs: [],
},
'ba-mushroom-gruyere-quiche': {
  recipesAnalyzed: 16,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'America\'s Test Kitchen'],
  ingredients: [
    { label: 'Pastry', consensus: 'All-butter shortcrust', percentage: 82 },
    { label: 'Cheese', consensus: 'Gruyère', percentage: 80 },
    { label: 'Custard ratio', consensus: '3 eggs to 1.5 cups cream', percentage: 72, alternative: 'More eggs for firmer set', altPercentage: 28 },
    { label: 'Mushrooms', consensus: 'Sautéed cremini or mixed, well dried', percentage: 78 },
    { label: 'Shallots', consensus: 'Shallots or onion, sautéed', percentage: 75 },
  ],
  techniques: [
    { label: 'Blind baking', consensus: 'Blind bake crust until golden', percentage: 85 },
    { label: 'Baking temp', consensus: '325-350°F until just set, slight wobble', percentage: 80 },
    { label: 'Cooling', consensus: 'Cool 15 min before slicing', percentage: 72 },
  ],
  differs: [],
},
'ba-mushroom-bourguignon': {
  recipesAnalyzed: 14,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Smitten Kitchen'],
  ingredients: [
    { label: 'Mushrooms', consensus: 'Portobello and cremini combination', percentage: 68, alternative: 'Mixed wild mushrooms', altPercentage: 32 },
    { label: 'Wine', consensus: 'Good-quality Burgundy or Pinot Noir', percentage: 82 },
    { label: 'Pearl onions', consensus: 'Pearl onions braised separately', percentage: 72, alternative: 'Shallots instead', altPercentage: 28 },
    { label: 'Aromatics', consensus: 'Garlic, thyme, bay leaf, carrot', percentage: 80 },
    { label: 'Butter finish', consensus: 'Cold butter swirled in at end', percentage: 70 },
  ],
  techniques: [
    { label: 'Mushroom browning', consensus: 'Sear in batches without crowding', percentage: 88 },
    { label: 'Wine reduction', consensus: 'Reduce wine by half before adding stock', percentage: 78 },
    { label: 'Finishing', consensus: 'Adjust thickness with beurre manié if needed', percentage: 62 },
  ],
  differs: [],
},
'one-pot-chicken-with-caramelized-lemon-and-dates-mmnq9hp8': {
  recipesAnalyzed: 12,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Chicken', consensus: 'Bone-in thighs', percentage: 80, alternative: 'Whole cut-up chicken', altPercentage: 20 },
    { label: 'Lemon', consensus: 'Whole lemon slices, caramelized in pan', percentage: 85 },
    { label: 'Dates', consensus: 'Medjool dates, halved', percentage: 82 },
    { label: 'Aromatics', consensus: 'Garlic, onion, cumin', percentage: 75 },
    { label: 'Liquid', consensus: 'Chicken broth, small amount', percentage: 70 },
  ],
  techniques: [
    { label: 'Searing', consensus: 'Skin-side down first, render fat fully', percentage: 88 },
    { label: 'Lemon caramelizing', consensus: 'Caramelize lemon slices in chicken fat', percentage: 82 },
    { label: 'Oven finish', consensus: 'Finish in 400°F oven', percentage: 75 },
  ],
  differs: [],
},
...
'orecchiette-con-cime-di-rapa': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Greens', consensus: 'Rapini (broccoli rabe)', percentage: 85 },
    { label: 'Pasta', consensus: 'Fresh or dry orecchiette', percentage: 88 },
    { label: 'Sausage', consensus: 'Fennel sausage', percentage: 68, alternative: 'No sausage (vegetarian)', altPercentage: 32 },
    { label: 'Anchovy', consensus: 'Anchovy in the oil', percentage: 72, alternative: 'No anchovy', altPercentage: 28 },
    { label: 'Chili', consensus: 'Peperoncino or red pepper flakes', percentage: 78 },
  ],
  techniques: [
    { label: 'Greens cooking', consensus: 'Blanch rapini in pasta water, then sauté', percentage: 72, alternative: 'Sauté raw greens', altPercentage: 28 },
    { label: 'Pasta water', consensus: 'Use cooking water for sauce', percentage: 82 },
  ],
  differs: [],
},
'overnight-oats-j5riw131': {
  recipesAnalyzed: 15,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Bon Appétit', 'The Spruce Eats'],
  ingredients: [
    { label: 'Oats', consensus: 'Rolled oats (old-fashioned)', percentage: 80, alternative: 'Quick oats for softer texture', altPercentage: 20 },
    { label: 'Liquid', consensus: 'Milk (dairy or non-dairy)', percentage: 82 },
    { label: 'Yogurt', consensus: 'Greek yogurt for creaminess and protein', percentage: 68, alternative: 'No yogurt', altPercentage: 32 },
    { label: 'Ratio', consensus: '1:1 oats to liquid', percentage: 72, alternative: '1:1.5 for looser texture', altPercentage: 28 },
    { label: 'Sweetener', consensus: 'Maple syrup or honey', percentage: 70, alternative: 'No sweetener', altPercentage: 30 },
  ],
  techniques: [
    { label: 'Soak time', consensus: 'At least 6 hours, overnight preferred', percentage: 85 },
    { label: 'Toppings', consensus: 'Add fresh toppings just before eating', percentage: 82 },
  ],
  differs: [],
},
'pasta-al-limone': {
  ...
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Saveur', 'Bon Appétit'],
  ingredients: [
    { label: 'Pasta shape', consensus: 'Spaghetti or linguine', percentage: 72, alternative: 'Rigatoni', altPercentage: 28 },
    { label: 'Lemon', consensus: 'Both zest and juice', percentage: 90 },
    { label: 'Dairy', consensus: 'Butter and Parmesan', percentage: 68, alternative: 'Cream for richer sauce', altPercentage: 32 },
    { label: 'Garlic', consensus: 'Light garlic or none', percentage: 55, alternative: 'No garlic, lemon only', altPercentage: 45 },
  ],
  techniques: [
    { label: 'Emulsification', consensus: 'Starchy pasta water key to sauce', percentage: 85 },
    { label: 'Zest timing', consensus: 'Add most zest off heat', percentage: 72 },
  ],
  differs: [],
},
'pasta-alla-gricia': {
  ...
  sources: ['Serious Eats', 'NYT Cooking', 'Saveur', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Pork', consensus: 'Guanciale, cubed', percentage: 78, alternative: 'Pancetta', altPercentage: 22 },
    { label: 'Cheese', consensus: 'Pecorino Romano, generous', percentage: 85 },
    { label: 'Pasta shape', consensus: 'Rigatoni or tonnarelli', percentage: 70, alternative: 'Spaghetti', altPercentage: 30 },
    { label: 'Pepper', consensus: 'Black pepper, coarsely ground, toasted', percentage: 82 },
  ],
  techniques: [
    { label: 'Emulsification', consensus: 'Starchy pasta water creates creamy sauce', percentage: 90 },
    { label: 'Guanciale rendering', consensus: 'Render slowly until crispy outside, chewy inside', percentage: 80 },
    { label: 'Cheese timing', consensus: 'Off heat, cheese added with pasta water', percentage: 82 },
  ],
  differs: [],
},
'peanut-butter-cookies-2qzfe0tb': {
  recipesAnalyzed: 20,
  sources: ['King Arthur Baking', 'America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Smitten Kitchen'],
  ingredients: [
    { label: 'Peanut butter type', consensus: 'Commercial creamy (Jif, Skippy)', percentage: 68, alternative: 'Natural peanut butter', altPercentage: 32 },
    { label: 'Sugar', consensus: 'Both white and brown sugar', percentage: 75, alternative: 'All white sugar', altPercentage: 25 },
    { label: 'Flour', consensus: 'All-purpose flour', percentage: 72, alternative: 'Flourless (all peanut butter)', altPercentage: 28 },
    { label: 'Eggs', consensus: '1 egg', percentage: 80 },
  ],
  techniques: [
    { label: 'Fork crosshatch', consensus: 'Press fork crosshatch pattern', percentage: 88 },
    { label: 'Baking', consensus: 'Until edges set, centers still soft', percentage: 78 },
  ],
  differs: [],
},
'ba-penne-alla-vodka': {
  ...
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'America\'s Test Kitchen'],
  ingredients: [
    { label: 'Pasta shape', consensus: 'Penne rigate', percentage: 80 },
    { label: 'Vodka', consensus: 'Good-quality vodka, generous splash', percentage: 82 },
    { label: 'Cream', consensus: 'Heavy cream', percentage: 78 },
    { label: 'Tomatoes', consensus: 'Canned whole tomatoes, crushed', percentage: 75 },
    { label: 'Heat', consensus: 'Red pepper flakes', percentage: 72 },
  ],
  techniques: [
    { label: 'Vodka cooking', consensus: 'Cook vodka with tomatoes 2-3 min to mellow', percentage: 80 },
    { label: 'Cream addition', consensus: 'Add cream after tomatoes simmer, not before', percentage: 75 },
    { label: 'Pasta water', consensus: 'Reserve for sauce consistency', percentage: 78 },
  ],
  differs: [],
},
'peperonata': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Peppers', consensus: 'Mixed sweet peppers (red, yellow, orange)', percentage: 82 },
    { label: 'Onion', consensus: 'Lots of onion, thinly sliced', percentage: 80 },
    { label: 'Tomatoes', consensus: 'Canned or fresh tomatoes', percentage: 72, alternative: 'No tomato', altPercentage: 28 },
    { label: 'Fat', consensus: 'Olive oil', percentage: 88 },
    { label: 'Acid', consensus: 'Red wine vinegar or capers', percentage: 65, alternative: 'No acid', altPercentage: 35 },
  ],
  techniques: [
    { label: 'Cooking time', consensus: 'Long and slow, 30+ min until very soft', percentage: 82 },
    { label: 'Texture', consensus: 'Jammy, almost melted', percentage: 80 },
  ],
  differs: [],
},
...
'piadina-romagnola': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Epicurious', 'Serious Eats'],
  ingredients: [
    { label: 'Fat', consensus: 'Lard (traditional)', percentage: 65, alternative: 'Olive oil', altPercentage: 35 },
    { label: 'Leavening', consensus: 'Baking soda, small amount', percentage: 72, alternative: 'No leavening', altPercentage: 28 },
    { label: 'Filling', consensus: 'Prosciutto, arugula, squacquerone', percentage: 68, alternative: 'Mortadella and cheese', altPercentage: 32 },
    { label: 'Thickness', consensus: 'Thin, 3-4mm', percentage: 78, alternative: 'Thicker, more bread-like', altPercentage: 22 },
  ],
  techniques: [
    { label: 'Cooking surface', consensus: 'Dry griddle (testo) or cast iron, no oil', percentage: 82 },
    { label: 'Heat', consensus: 'Medium-high, cook 2-3 min each side', percentage: 78 },
  ],
  differs: [],
},
'pico-de-gallo-7qul7pnp': {
  recipesAnalyzed: 16,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'Bon Appétit', 'Epicurious'],
  ingredients: [
    { label: 'Tomatoes', consensus: 'Ripe Roma or vine tomatoes, seeded', percentage: 78 },
    { label: 'Onion', consensus: 'White onion, finely diced', percentage: 80 },
    { label: 'Cilantro', consensus: 'Fresh cilantro, generous', percentage: 85 },
    { label: 'Chili', consensus: 'Jalapeño or serrano, seeded or not', percentage: 82 },
    { label: 'Lime', consensus: 'Fresh lime juice', percentage: 88 },
  ],
  techniques: [
    { label: 'Salting tomatoes', consensus: 'Salt tomatoes briefly to draw out excess liquid', percentage: 62, alternative: 'Skip salting', altPercentage: 38 },
    { label: 'Rest time', consensus: 'Rest 15 min before serving', percentage: 72 },
  ],
  differs: [],
},
'pizza-margherita': {
  recipesAnalyzed: 22,
  sources: ['Serious Eats', 'NYT Cooking', 'Food52', 'King Arthur Baking', 'Saveur'],
  ingredients: [
    { label: 'Dough', consensus: 'High-hydration Neapolitan dough', percentage: 75 },
    { label: 'Flour', consensus: 'Tipo 00 or bread flour', percentage: 68, alternative: 'All-purpose', altPercentage: 32 },
    { label: 'Sauce', consensus: 'Raw San Marzano tomatoes, blended', percentage: 80 },
    { label: 'Mozzarella', consensus: 'Fresh mozzarella (fior di latte)', percentage: 72, alternative: 'Low-moisture mozzarella', altPercentage: 28 },
    { label: 'Basil', consensus: 'Fresh basil added after baking', percentage: 82 },
  ],
  techniques: [
    { label: 'Baking temp', consensus: 'As hot as possible (500°F+ home oven)', percentage: 85 },
    { label: 'Preheat', consensus: 'Pizza stone preheated 1 hour', percentage: 78, alternative: 'Pizza steel', altPercentage: 22 },
    { label: 'Dough ferment', consensus: 'Cold ferment 24-72 hours', percentage: 72, alternative: 'Same day', altPercentage: 28 },
  ],
  differs: [],
},
'polenta-e-funghi': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Polenta', consensus: 'Coarse-ground polenta', percentage: 75, alternative: 'Quick polenta', altPercentage: 25 },
    { label: 'Mushrooms', consensus: 'Mixed mushrooms, including porcini or dried', percentage: 72, alternative: 'Cremini only', altPercentage: 28 },
    { label: 'Polenta enrichment', consensus: 'Butter and Parmesan stirred in', percentage: 82 },
    { label: 'Mushroom sauce', consensus: 'Garlic, thyme, white wine in sauce', percentage: 78 },
  ],
  techniques: [
    { label: 'Polenta cooking', consensus: 'Slow stir, 30-45 min for best texture', percentage: 72, alternative: 'Oven polenta for less stirring', altPercentage: 28 },
    { label: 'Mushroom searing', consensus: 'High heat, don\'t crowd, deep brown', percentage: 85 },
  ],
  differs: [],
},
'pollo-alla-cacciatora': {
  ...
  sources: ['Saveur', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Chicken', consensus: 'Bone-in, skin-on pieces', percentage: 85 },
    { label: 'Tomatoes', consensus: 'Canned whole tomatoes', percentage: 72, alternative: 'Fresh tomatoes', altPercentage: 28 },
    { label: 'Wine', consensus: 'Red wine (or white depending on region)', percentage: 65, alternative: 'White wine', altPercentage: 35 },
    { label: 'Olives', consensus: 'Kalamata or Gaeta olives', percentage: 62, alternative: 'No olives', altPercentage: 38 },
    { label: 'Aromatics', consensus: 'Onion, garlic, bell pepper, capers', percentage: 78 },
  ],
  techniques: [
    { label: 'Searing', consensus: 'Brown chicken well before braising', percentage: 90 },
    { label: 'Braise time', consensus: '40-50 min until fall-off-bone', percentage: 80 },
  ],
  differs: [],
},
'porchetta': {
  ...
  sources: ['Serious Eats', 'NYT Cooking', 'Saveur', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Pork cut', consensus: 'Pork belly wrapped around loin', percentage: 72, alternative: 'Pork shoulder', altPercentage: 28 },
    { label: 'Herb mixture', consensus: 'Fennel fronds/seeds, rosemary, garlic, sage', percentage: 85 },
    { label: 'Seasoning', consensus: 'Heavy salt, pepper, fennel seed', percentage: 82 },
    { label: 'Skin', consensus: 'Skin-on for crackling', percentage: 88 },
  ],
  techniques: [
    { label: 'Dry brining', consensus: 'Salt overnight uncovered in fridge', percentage: 78 },
    { label: 'Roasting', consensus: 'Start high heat, reduce for long roast, finish high', percentage: 75, alternative: 'Low and slow only', altPercentage: 25 },
    { label: 'Resting', consensus: 'Rest 30 min before slicing', percentage: 82 },
  ],
  differs: [],
},
'potato-leek-soup-with-herb-caper-gremolata-9gx0fl7y': {
  recipesAnalyzed: 15,
  sources: ['NYT Cooking', 'Food52', 'Serious Eats', 'Bon Appétit', 'Epicurious'],
  ingredients: [
    { label: 'Potatoes', consensus: 'Yukon Gold, waxy texture', percentage: 72, alternative: 'Russet for floury texture', altPercentage: 28 },
    { label: 'Leeks', consensus: 'Lots of leeks, all white and light green parts', percentage: 85 },
    { label: 'Fat', consensus: 'Butter for sweating leeks', percentage: 78 },
    { label: 'Gremolata', consensus: 'Herbs, capers, lemon zest, olive oil', percentage: 80 },
  ],
  techniques: [
    { label: 'Leek cooking', consensus: 'Sweat gently until very soft, not browned', percentage: 82 },
    { label: 'Blending', consensus: 'Blend smooth', percentage: 78, alternative: 'Leave chunky', altPercentage: 22 },
    { label: 'Gremolata', consensus: 'Add gremolata just before serving', percentage: 88 },
  ],
  differs: [],
},

'pressure-cooker-chicken-noodle-soup-72ihe2l6': {
  recipesAnalyzed: 15,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food Network', 'Allrecipes'],
  ingredients: [
    { label: 'Chicken', consensus: 'Bone-in thighs for flavor', percentage: 72, alternative: 'Whole chicken', altPercentage: 28 },
    { label: 'Noodles', consensus: 'Egg noodles, medium width', percentage: 78, alternative: 'Wide egg noodles', altPercentage: 22 },
    { label: 'Aromatics', consensus: 'Onion, carrot, celery, bay, thyme', percentage: 85 },
    { label: 'Noodle timing', consensus: 'Cook noodles separately or add after pressure release', percentage: 72, alternative: 'Cook in broth from start', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Pressure cooking', consensus: 'High pressure 15-20 min for broth depth', percentage: 80 },
    { label: 'Noodle add', consensus: 'Add noodles after pressure release on sauté mode', percentage: 72 },
  ],
  differs: [],
},
'ragu-alla-napoletana': {
  ...
  sources: ['Saveur', 'Serious Eats', 'Food52', 'NYT Cooking', 'Epicurious'],
  ingredients: [
    { label: 'Meat', consensus: 'Pork ribs, braciole, and sausage combination', percentage: 72, alternative: 'Beef only', altPercentage: 28 },
    { label: 'Tomatoes', consensus: 'San Marzano, whole or crushed', percentage: 82 },
    { label: 'Wine', consensus: 'Red wine', percentage: 78 },
    { label: 'Pork fat', consensus: 'Lardo or pancetta base', percentage: 68, alternative: 'Olive oil only', altPercentage: 32 },
  ],
  techniques: [
    { label: 'Cook time', consensus: 'All-day simmer, 4-6 hours minimum', percentage: 88 },
    { label: 'Heat', consensus: 'Barely a simmer, just occasional bubble', percentage: 82 },
    { label: 'Serving', consensus: 'Serve sauce over pasta first, meat as second course', percentage: 70 },
  ],
  differs: [],
},
'risotto-ai-frutti-di-mare': {
  ...
  sources: ['Saveur', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Rice', consensus: 'Carnaroli or Vialone Nano', percentage: 72, alternative: 'Arborio', altPercentage: 28 },
    { label: 'Seafood mix', consensus: 'Clams, mussels, shrimp, squid', percentage: 80 },
    { label: 'Stock', consensus: 'Seafood or fish stock', percentage: 85 },
    { label: 'Wine', consensus: 'Dry white wine, generous', percentage: 82 },
    { label: 'Cheese', consensus: 'No cheese with seafood (traditional)', percentage: 72, alternative: 'Light Parmesan', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Seafood timing', consensus: 'Add shellfish last few min, don\'t overcook', percentage: 88 },
    { label: 'Mantecatura', consensus: 'Finish with butter off heat, stir vigorously', percentage: 80 },
  ],
  differs: [],
},
'risotto-al-limone': {
  ...
  sources: ['Saveur', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Rice', consensus: 'Carnaroli or Arborio', percentage: 75 },
    { label: 'Lemon', consensus: 'Juice and zest, both', percentage: 88 },
    { label: 'Butter finish', consensus: 'Cold butter at end', percentage: 82 },
    { label: 'Parmesan', consensus: 'Good Parmigiano-Reggiano', percentage: 80 },
    { label: 'Stock', consensus: 'Light chicken or vegetable stock', percentage: 72, alternative: 'Water for purer lemon flavor', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Lemon timing', consensus: 'Add lemon off heat to preserve brightness', percentage: 78 },
    { label: 'Texture', consensus: 'All\'onda (flowing, not stiff)', percentage: 82 },
    { label: 'Mantecatura', consensus: 'Vigorous butter and cheese fold off heat', percentage: 80 },
  ],
  differs: [],
},

'roasted-brussels-sprouts-kygk2pa0': {
  recipesAnalyzed: 18,
  sources: ['Serious Eats', 'NYT Cooking', 'America\'s Test Kitchen', 'Bon Appétit', 'Food52'],
  ingredients: [
    { label: 'Fat', consensus: 'Olive oil, generous coating', percentage: 85 },
    { label: 'Preparation', consensus: 'Halved, cut side down', percentage: 82 },
    { label: 'Additions', consensus: 'Nothing extra (let them caramelize)', percentage: 58, alternative: 'Balsamic glaze or bacon', altPercentage: 42 },
    { label: 'Outer leaves', consensus: 'Keep loose leaves for extra crispy bits', percentage: 68 },
  ],
  techniques: [
    { label: 'Oven temp', consensus: '425-450°F', percentage: 88 },
    { label: 'Spacing', consensus: 'Single layer, not crowded', percentage: 90 },
    { label: 'Cut side down', consensus: 'Cut side flat on pan for browning', percentage: 85 },
  ],
  differs: [],
},
'ba-roasted-carrot-ginger-soup': {
  recipesAnalyzed: 14,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Carrots', consensus: 'Roasted before blending', percentage: 72, alternative: 'Simmered raw in broth', altPercentage: 28 },
    { label: 'Ginger', consensus: 'Fresh ginger, generous', percentage: 85 },
    { label: 'Coconut milk', consensus: 'Coconut milk for creaminess', percentage: 65, alternative: 'Heavy cream or no dairy', altPercentage: 35 },
    { label: 'Aromatics', consensus: 'Onion, garlic, ginger', percentage: 82 },
    { label: 'Acid', consensus: 'Lime juice at end', percentage: 70 },
  ],
  techniques: [
    { label: 'Roasting', consensus: 'Roast carrots until caramelized for depth', percentage: 78 },
    { label: 'Blending', consensus: 'Blend until silky smooth', percentage: 85 },
  ],
  differs: [],
},
'roasted-sweet-potatoes-b2y2rg2c': {
  recipesAnalyzed: 16,
  sources: ['Serious Eats', 'NYT Cooking', 'America\'s Test Kitchen', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Cut style', consensus: 'Cubed or halved, depending on use', percentage: 72 },
    { label: 'Fat', consensus: 'Olive oil or neutral oil', percentage: 82 },
    { label: 'Seasoning', consensus: 'Salt, pepper, sometimes smoked paprika', percentage: 78 },
    { label: 'Sweetener', consensus: 'No extra sweetener (natural sugars enough)', percentage: 68, alternative: 'Maple syrup glaze', altPercentage: 32 },
  ],
  techniques: [
    { label: 'Oven temp', consensus: '400-425°F', percentage: 82 },
    { label: 'Spacing', consensus: 'Single layer, not touching', percentage: 88 },
    { label: 'Flipping', consensus: 'Flip once halfway', percentage: 75 },
  ],
  differs: [],
},
'ba-roasted-vegetable-lasagna': {
  recipesAnalyzed: 14,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Vegetables', consensus: 'Zucchini, eggplant, bell pepper, roasted', percentage: 72, alternative: 'Mushrooms as primary veg', altPercentage: 28 },
    { label: 'Cheese layers', consensus: 'Ricotta, mozzarella, Parmesan', percentage: 80 },
    { label: 'Sauce', consensus: 'Tomato sauce plus béchamel', percentage: 65, alternative: 'Tomato sauce only', altPercentage: 35 },
    { label: 'Pasta', consensus: 'Dry lasagna noodles, boiled first', percentage: 68, alternative: 'No-boil sheets', altPercentage: 32 },
  ],
  techniques: [
    { label: 'Vegetable roasting', consensus: 'Roast separately before assembling', percentage: 82 },
    { label: 'Moisture control', consensus: 'Drain/press vegetables to avoid soggy lasagna', percentage: 78 },
  ],
  differs: [],
},
...
'salsa-verde': {
  ...
  sources: ['Saveur', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Herbs', consensus: 'Flat-leaf parsley as base', percentage: 82 },
    { label: 'Capers', consensus: 'Capers, rinsed', percentage: 80 },
    { label: 'Anchovy', consensus: 'Anchovy fillets', percentage: 72, alternative: 'No anchovy for vegetarian', altPercentage: 28 },
    { label: 'Acid', consensus: 'Red wine vinegar or lemon juice', percentage: 75 },
    { label: 'Garlic', consensus: 'Raw garlic, small amount', percentage: 70 },
  ],
  techniques: [
    { label: 'Method', consensus: 'Hand-chopped for texture', percentage: 65, alternative: 'Blended smooth', altPercentage: 35 },
    { label: 'Oil', consensus: 'Good olive oil, emulsified in', percentage: 80 },
  ],
  differs: [],
},
'scaloppine-al-limone': {
  ...
  sources: ['Saveur', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Meat', consensus: 'Veal, pounded thin', percentage: 72, alternative: 'Chicken or pork', altPercentage: 28 },
    { label: 'Dredge', consensus: 'Light flour coating', percentage: 82 },
    { label: 'Lemon', consensus: 'Fresh lemon juice, plenty', percentage: 88 },
    { label: 'Butter', consensus: 'Cold butter mounted into sauce', percentage: 80 },
    { label: 'Wine', consensus: 'Dry white wine deglaze', percentage: 72, alternative: 'Broth only', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Cooking speed', consensus: 'Very quick, 1-2 min per side only', percentage: 85 },
    { label: 'Pan sauce', consensus: 'Deglaze, reduce, mount with butter', percentage: 82 },
    { label: 'Capers', consensus: 'Capers optional but common', percentage: 62, alternative: 'No capers', altPercentage: 38 },
  ],
  differs: [],
},
'seafood-chowder-mmy9lntf': {
  recipesAnalyzed: 16,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Seafood mix', consensus: 'Clams, shrimp, scallops, fish', percentage: 72 },
    { label: 'Base', consensus: 'Roux-based cream chowder', percentage: 78 },
    { label: 'Potatoes', consensus: 'Yukon Gold, small cubes', percentage: 80 },
    { label: 'Smoked element', consensus: 'Smoked fish or bacon', percentage: 65, alternative: 'No smoked element', altPercentage: 35 },
    { label: 'Dairy', consensus: 'Heavy cream and whole milk', percentage: 72 },
  ],
  techniques: [
    { label: 'Seafood timing', consensus: 'Add seafood last, gentle simmer only', percentage: 88 },
    { label: 'Clam liquor', consensus: 'Use clam juice in broth base', percentage: 78 },
  ],
  differs: [],
},
'semifreddo-al-limone': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Eggs', consensus: 'Separated eggs, yolks for base, whites whipped', percentage: 78 },
    { label: 'Lemon', consensus: 'Zest and juice both', percentage: 85 },
    { label: 'Cream', consensus: 'Whipped heavy cream folded in', percentage: 82 },
    { label: 'Sugar', consensus: 'Granulated sugar in custard base', percentage: 78 },
  ],
  techniques: [
    { label: 'Folding', consensus: 'Fold whites and cream gently to keep air', percentage: 88 },
    { label: 'Base method', consensus: 'Sabayon or Italian meringue as base', percentage: 70, alternative: 'Straight custard', altPercentage: 30 },
    { label: 'Freezing', consensus: 'Freeze in lined loaf pan, 6+ hours', percentage: 82 },
  ],
  differs: [],
},
...
'sicilian-caponata': {
  ...
  sources: ['Saveur', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Eggplant', consensus: 'Cubed and salted, then fried', percentage: 78 },
    { label: 'Acid', consensus: 'Red wine vinegar', percentage: 82 },
    { label: 'Sweetener', consensus: 'Sugar for agrodolce', percentage: 80 },
    { label: 'Mix-ins', consensus: 'Olives, capers, celery, pine nuts', percentage: 72 },
    { label: 'Tomatoes', consensus: 'Fresh or canned tomatoes', percentage: 75 },
  ],
  techniques: [
    { label: 'Eggplant frying', consensus: 'Fry separately until golden before combining', percentage: 82 },
    { label: 'Agrodolce balance', consensus: 'Sweet-sour balance, taste and adjust', percentage: 85 },
    { label: 'Resting', consensus: 'Better at room temp or next day', percentage: 78 },
  ],
  differs: [],
},
'skillet-chicken-pot-pie-p1ybpkka': {
  recipesAnalyzed: 16,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Crust', consensus: 'Store-bought puff pastry or biscuit top', percentage: 65, alternative: 'Homemade pie dough', altPercentage: 35 },
    { label: 'Chicken', consensus: 'Cooked chicken, rotisserie or poached', percentage: 72, alternative: 'Raw chicken cooked in filling', altPercentage: 28 },
    { label: 'Vegetables', consensus: 'Peas, carrots, celery, onion', percentage: 82 },
    { label: 'Sauce', consensus: 'Cream sauce with roux base', percentage: 80 },
    { label: 'Herbs', consensus: 'Thyme and sage', percentage: 70 },
  ],
  techniques: [
    { label: 'One-pan', consensus: 'Make filling in skillet, top and bake', percentage: 75 },
    { label: 'Crust', consensus: 'Bake until crust golden brown and bubbling', percentage: 85 },
  ],
  differs: [],
},
'sloppy-joes-lo51hina': {
  recipesAnalyzed: 16,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food Network', 'Allrecipes'],
  ingredients: [
    { label: 'Meat', consensus: 'Ground beef (80/20)', percentage: 78, alternative: 'Ground turkey', altPercentage: 22 },
    { label: 'Sauce base', consensus: 'Ketchup, tomato paste, Worcestershire', percentage: 80 },
    { label: 'Sweetener', consensus: 'Brown sugar', percentage: 72, alternative: 'No added sugar', altPercentage: 28 },
    { label: 'Aromatics', consensus: 'Onion, garlic, bell pepper', percentage: 82 },
    { label: 'Buns', consensus: 'Toasted hamburger buns', percentage: 78 },
  ],
  techniques: [
    { label: 'Fat draining', consensus: 'Drain excess fat after browning meat', percentage: 72, alternative: 'Keep fat for flavor', altPercentage: 28 },
    { label: 'Sauce reduction', consensus: 'Simmer until thick, not soupy', percentage: 82 },
  ],
  differs: [],
},
'spaghetti-alle-vongole': {
  ...
  sources: ['Serious Eats', 'NYT Cooking', 'Saveur', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Clams', consensus: 'Small Manila or littleneck clams, live', percentage: 82 },
    { label: 'Wine', consensus: 'Dry white wine', percentage: 85 },
    { label: 'Garlic', consensus: 'Sliced garlic, lightly golden', percentage: 88 },
    { label: 'Red pepper', consensus: 'Peperoncino or red pepper flakes', percentage: 75 },
    { label: 'Red or white', consensus: 'White (bianco) version, no tomato', percentage: 72, alternative: 'Red version with tomato', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Pasta water', consensus: 'Starchy pasta water for sauce emulsification', percentage: 88 },
    { label: 'Clam timing', consensus: 'Open clams in wine, add pasta to finish', percentage: 82 },
    { label: 'Cheese', consensus: 'No cheese with seafood (traditional)', percentage: 78 },
  ],
  differs: [],
},

'spiced-pea-stew-with-yogurt-mmxx51h5': {
  recipesAnalyzed: 12,
  sources: ['NYT Cooking', 'Food52', 'Bon Appétit', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Peas', consensus: 'Frozen peas, added at end', percentage: 72, alternative: 'Fresh peas in season', altPercentage: 28 },
    { label: 'Spices', consensus: 'Turmeric, cumin, coriander, cinnamon', percentage: 80 },
    { label: 'Yogurt', consensus: 'Full-fat Greek yogurt, dolloped on top', percentage: 82 },
    { label: 'Aromatics', consensus: 'Onion, garlic, ginger', percentage: 85 },
    { label: 'Tomatoes', consensus: 'Canned tomatoes', percentage: 68, alternative: 'No tomato', altPercentage: 32 },
  ],
  techniques: [
    { label: 'Blooming spices', consensus: 'Toast spices in oil before adding liquid', percentage: 82 },
    { label: 'Pea timing', consensus: 'Add peas in last 5 min to keep bright green', percentage: 80 },
  ],
  differs: [],
},
'split-pea-soup-with-ham-720qz8dv': {
  recipesAnalyzed: 18,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food52', 'Allrecipes'],
  ingredients: [
    { label: 'Peas', consensus: 'Dried split peas, green or yellow', percentage: 80 },
    { label: 'Ham', consensus: 'Ham hock or ham bone', percentage: 82 },
    { label: 'Aromatics', consensus: 'Onion, carrot, celery, garlic', percentage: 85 },
    { label: 'Herbs', consensus: 'Bay leaf, thyme', percentage: 78 },
  ],
  techniques: [
    { label: 'Soaking', consensus: 'No soaking needed for split peas', percentage: 72, alternative: 'Soak overnight for faster cook', altPercentage: 28 },
    { label: 'Pea texture', consensus: 'Cook until completely dissolved and creamy', percentage: 82 },
    { label: 'Ham', consensus: 'Remove bone, shred meat and return', percentage: 80 },
  ],
  differs: [],
},
'stovetop-mac-and-cheese-sq3io39a': {
  recipesAnalyzed: 20,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Bon Appétit', 'Food52'],
  ingredients: [
    { label: 'Cheese', consensus: 'Sharp cheddar, freshly grated', percentage: 80, alternative: 'Cheddar and Gruyère blend', altPercentage: 20 },
    { label: 'Pasta shape', consensus: 'Elbow macaroni', percentage: 78, alternative: 'Cavatappi or shells', altPercentage: 22 },
    { label: 'Sauce base', consensus: 'Béchamel (roux-based)', percentage: 72, alternative: 'Evaporated milk shortcut', altPercentage: 28 },
    { label: 'Milk', consensus: 'Whole milk plus evaporated milk', percentage: 62, alternative: 'Whole milk only', altPercentage: 38 },
  ],
  techniques: [
    { label: 'Cheese melting', consensus: 'Off heat, add cheese gradually', percentage: 82 },
    { label: 'Pasta water', consensus: 'Reserve for sauce thinning', percentage: 72 },
    { label: 'Mustard', consensus: 'Dry mustard or Dijon in sauce', percentage: 65, alternative: 'No mustard', altPercentage: 35 },
  ],
  differs: [],
},
'ba-stuffed-bell-peppers': {
  recipesAnalyzed: 16,
  sources: ['Bon Appétit', 'America\'s Test Kitchen', 'NYT Cooking', 'Food52', 'Allrecipes'],
  ingredients: [
    { label: 'Peppers', consensus: 'Bell peppers, tops cut and reserved', percentage: 80 },
    { label: 'Rice', consensus: 'Cooked white rice', percentage: 72, alternative: 'Brown rice or cauliflower rice', altPercentage: 28 },
    { label: 'Beans', consensus: 'Black beans', percentage: 70, alternative: 'Pinto beans', altPercentage: 30 },
    { label: 'Cheese', consensus: 'Melted cheese on top', percentage: 78 },
    { label: 'Sauce', consensus: 'Tomato sauce inside and poured over', percentage: 75 },
  ],
  techniques: [
    { label: 'Pre-cooking peppers', consensus: 'Blanch or roast peppers before stuffing', percentage: 62, alternative: 'Fill raw, longer bake', altPercentage: 38 },
    { label: 'Baking', consensus: 'Covered then uncover to melt cheese', percentage: 78 },
  ],
  differs: [],
},
'tagliatelle-al-ragu': {
  ...
  sources: ['Serious Eats', 'NYT Cooking', 'Saveur', 'Food52', 'Bon Appétit'],
  ingredients: [
    { label: 'Pasta', consensus: 'Fresh egg tagliatelle', percentage: 78, alternative: 'Dry tagliatelle', altPercentage: 22 },
    { label: 'Meat', consensus: 'Beef and pork combination', percentage: 72, alternative: 'Beef only', altPercentage: 28 },
    { label: 'Milk/cream', consensus: 'Whole milk added during cooking', percentage: 65, alternative: 'No dairy', altPercentage: 35 },
    { label: 'Tomato', consensus: 'Small amount of tomato paste only', percentage: 62, alternative: 'Canned tomatoes', altPercentage: 38 },
    { label: 'Wine', consensus: 'White wine (traditional bolognese)', percentage: 60, alternative: 'Red wine', altPercentage: 40 },
  ],
  techniques: [
    { label: 'Cook time', consensus: 'Minimum 2 hours, 3-4 preferred', percentage: 85 },
    { label: 'Soffritto', consensus: 'Onion, carrot, celery base cooked until soft', percentage: 88 },
    { label: 'Meat texture', consensus: 'Very fine grain, not chunky', percentage: 72 },
  ],
  differs: [],
},

'ba-thai-red-curry-tofu': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'NYT Cooking', 'Serious Eats', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Tofu', consensus: 'Extra-firm tofu, pressed and pan-fried', percentage: 80 },
    { label: 'Curry paste', consensus: 'Store-bought red curry paste', percentage: 72, alternative: 'Homemade curry paste', altPercentage: 28 },
    { label: 'Coconut milk', consensus: 'Full-fat coconut milk', percentage: 85 },
    { label: 'Vegetables', consensus: 'Bell pepper, bamboo shoots, Thai eggplant', percentage: 72 },
    { label: 'Fish sauce substitute', consensus: 'Soy sauce or tamari for vegetarian', percentage: 68 },
  ],
  techniques: [
    { label: 'Paste blooming', consensus: 'Fry curry paste in coconut cream before adding milk', percentage: 78 },
    { label: 'Tofu crisping', consensus: 'Pan-fry tofu separately until golden', percentage: 82 },
    { label: 'Finish', consensus: 'Thai basil and lime leaf at end', percentage: 75 },
  ],
  differs: [],
},
'tortellini-in-brodo': {
  ...
  sources: ['Saveur', 'Food52', 'NYT Cooking', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Broth', consensus: 'Rich capon or chicken broth, very clear', percentage: 82 },
    { label: 'Filling', consensus: 'Pork, mortadella, Parmesan, nutmeg', percentage: 78 },
    { label: 'Pasta dough', consensus: 'Fresh egg pasta, very thin', percentage: 85 },
    { label: 'Finishing', consensus: 'Parmesan served separately for grating', percentage: 72 },
  ],
  techniques: [
    { label: 'Broth clarity', consensus: 'Skim constantly, clear broth is essential', percentage: 85 },
    { label: 'Tortellini size', consensus: 'Very small, traditional-sized', percentage: 78 },
    { label: 'Cooking in broth', consensus: 'Cook tortellini directly in serving broth', percentage: 80 },
  ],
  differs: [],
},
'trofie-al-pesto': {
  ...
  sources: ['Saveur', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Pasta', consensus: 'Trofie', percentage: 80, alternative: 'Trenette or linguine', altPercentage: 20 },
    { label: 'Pesto', consensus: 'Basil pesto (Genovese), made fresh', percentage: 85 },
    { label: 'Pesto ingredients', consensus: 'Basil, Parmesan, Pecorino, pine nuts, garlic, olive oil', percentage: 82 },
    { label: 'Add-ins', consensus: 'Green beans and potatoes (traditional)', percentage: 68, alternative: 'Pasta only', altPercentage: 32 },
  ],
  techniques: [
    { label: 'Pesto method', consensus: 'Mortar and pestle or food processor', percentage: 58, alternative: 'Blender', altPercentage: 42 },
    { label: 'Pesto temperature', consensus: 'Never heat pesto, add off heat', percentage: 85 },
    { label: 'Pasta water', consensus: 'Reserve starchy water to loosen pesto', percentage: 80 },
  ],
  differs: [],
},
'tuna-noodle-casserole-cup1scwc': {
  recipesAnalyzed: 16,
  sources: ['America\'s Test Kitchen', 'Serious Eats', 'NYT Cooking', 'Food Network', 'Allrecipes'],
  ingredients: [
    { label: 'Tuna', consensus: 'Canned tuna in water, drained', percentage: 80, alternative: 'Oil-packed tuna', altPercentage: 20 },
    { label: 'Noodles', consensus: 'Egg noodles', percentage: 82 },
    { label: 'Sauce', consensus: 'Béchamel-based cream sauce', percentage: 68, alternative: 'Cream of mushroom soup shortcut', altPercentage: 32 },
    { label: 'Vegetables', consensus: 'Peas, onion, celery', percentage: 78 },
    { label: 'Topping', consensus: 'Breadcrumb and cheese crust', percentage: 80, alternative: 'Potato chip topping', altPercentage: 20 },
  ],
  techniques: [
    { label: 'Pasta cooking', consensus: 'Undercook noodles before baking', percentage: 78 },
    { label: 'Topping', consensus: 'Broil last few minutes for golden crust', percentage: 75 },
  ],
  differs: [],
},
'ba-ultimate-grilled-cheese': {
  recipesAnalyzed: 18,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'America\'s Test Kitchen', 'Food52'],
  ingredients: [
    { label: 'Bread', consensus: 'Thick-cut white or sourdough', percentage: 72, alternative: 'White sandwich bread', altPercentage: 28 },
    { label: 'Cheese', consensus: 'American plus sharp cheddar blend', percentage: 65, alternative: 'Gruyère or fontina', altPercentage: 35 },
    { label: 'Fat', consensus: 'Mayo on outside or butter', percentage: 58, alternative: 'Butter only', altPercentage: 42 },
    { label: 'Add-ins', consensus: 'Plain cheese only', percentage: 62, alternative: 'Onion jam, dijon, or other', altPercentage: 38 },
  ],
  techniques: [
    { label: 'Heat', consensus: 'Low and slow for even melt', percentage: 80 },
    { label: 'Covering', consensus: 'Cover pan briefly to help cheese melt', percentage: 68, alternative: 'Open pan only', altPercentage: 32 },
  ],
  differs: [],
},
'ba-vegetable-fried-rice': {
  recipesAnalyzed: 17,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'The Woks of Life', 'Food52'],
  ingredients: [
    { label: 'Rice', consensus: 'Day-old cooked rice, cold', percentage: 88 },
    { label: 'Eggs', consensus: 'Eggs scrambled and mixed in', percentage: 82 },
    { label: 'Soy sauce', consensus: 'Light soy sauce', percentage: 80, alternative: 'Tamari', altPercentage: 20 },
    { label: 'Sesame oil', consensus: 'Toasted sesame oil at end', percentage: 78 },
    { label: 'Vegetables', consensus: 'Peas, carrots, corn, scallion', percentage: 80 },
  ],
  techniques: [
    { label: 'Heat', consensus: 'Wok or pan screaming hot', percentage: 88 },
    { label: 'Rice in batches', consensus: 'Spread and press, cook undisturbed for char', percentage: 80 },
    { label: 'Seasoning order', consensus: 'Soy at end, not at start', percentage: 72 },
  ],
  differs: [],
},
'ba-vegetable-pad-thai': {
  recipesAnalyzed: 16,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Noodles', consensus: 'Rice noodles, medium width, soaked', percentage: 82 },
    { label: 'Sauce', consensus: 'Fish sauce (or soy), tamarind, palm sugar', percentage: 80 },
    { label: 'Tamarind', consensus: 'Tamarind paste or concentrate', percentage: 78, alternative: 'Lime juice substitute', altPercentage: 22 },
    { label: 'Protein', consensus: 'Tofu or egg', percentage: 72 },
    { label: 'Toppings', consensus: 'Bean sprouts, peanuts, lime, scallion', percentage: 85 },
  ],
  techniques: [
    { label: 'Wok technique', consensus: 'High heat, work in batches', percentage: 82 },
    { label: 'Noodle hydration', consensus: 'Soak but not fully cook noodles before wok', percentage: 78 },
    { label: 'Eggs', consensus: 'Push to side, scramble eggs separately', percentage: 75 },
  ],
  differs: [],
},
'ba-vegetarian-mapo-tofu': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'Serious Eats', 'NYT Cooking', 'The Woks of Life', 'Food52'],
  ingredients: [
    { label: 'Tofu', consensus: 'Silken or soft tofu', percentage: 78, alternative: 'Firm tofu', altPercentage: 22 },
    { label: 'Doubanjiang', consensus: 'Sichuan doubanjiang (fermented bean paste)', percentage: 85 },
    { label: 'Heat', consensus: 'Sichuan peppercorn plus chili oil', percentage: 82 },
    { label: 'Mushrooms', consensus: 'Dried shiitake or king oyster instead of pork', percentage: 75, alternative: 'TVP or no meat substitute', altPercentage: 25 },
    { label: 'Broth', consensus: 'Vegetable broth', percentage: 78 },
  ],
  techniques: [
    { label: 'Tofu handling', consensus: 'Blanch tofu first, add gently to avoid breaking', percentage: 72 },
    { label: 'Thickening', consensus: 'Cornstarch slurry for silky sauce', percentage: 80 },
    { label: 'Sichuan pepper', consensus: 'Toast and grind fresh Sichuan pepper', percentage: 78 },
  ],
  differs: [],
},
'ba-vegetarian-tortilla-soup': {
  recipesAnalyzed: 14,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Tomatoes', consensus: 'Fire-roasted canned tomatoes', percentage: 72, alternative: 'Fresh tomatoes', altPercentage: 28 },
    { label: 'Chiles', consensus: 'Ancho or guajillo dried chiles, toasted', percentage: 68, alternative: 'Chipotles in adobo', altPercentage: 32 },
    { label: 'Beans', consensus: 'Black beans', percentage: 72, alternative: 'Pinto beans', altPercentage: 28 },
    { label: 'Tortilla strips', consensus: 'Homemade fried corn tortilla strips', percentage: 70, alternative: 'Store-bought tortilla chips', altPercentage: 30 },
    { label: 'Corn', consensus: 'Roasted or charred corn', percentage: 68, alternative: 'No corn', altPercentage: 32 },
  ],
  techniques: [
    { label: 'Chile prep', consensus: 'Toast dried chiles, soak, blend into soup', percentage: 72 },
    { label: 'Toppings', consensus: 'Avocado, sour cream, cheese, cilantro', percentage: 80 },
  ],
  differs: [],
},
'ba-whole-roasted-cauliflower-tahini': {
  recipesAnalyzed: 15,
  sources: ['Bon Appétit', 'NYT Cooking', 'Food52', 'Serious Eats', 'Epicurious'],
  ingredients: [
    { label: 'Cauliflower', consensus: 'Whole head, leaves trimmed but kept', percentage: 82 },
    { label: 'Oil coating', consensus: 'Olive oil, generous all over', percentage: 88 },
    { label: 'Tahini sauce', consensus: 'Tahini, lemon, garlic, water', percentage: 85 },
    { label: 'Spices', consensus: 'Cumin, coriander, turmeric', percentage: 72, alternative: 'Harissa-based marinade', altPercentage: 28 },
  ],
  techniques: [
    { label: 'Cooking method', consensus: 'Parboil briefly then roast high heat', percentage: 65, alternative: 'Roast raw from start at lower temp', altPercentage: 35 },
    { label: 'Browning', consensus: 'Deep golden-brown all over', percentage: 85 },
    { label: 'Resting', consensus: 'Rest before slicing into wedges', percentage: 72 },
  ],
  differs: [],
},
'zuppa-di-pesce': {
  ...
  sources: ['Saveur', 'Serious Eats', 'NYT Cooking', 'Food52', 'Epicurious'],
  ingredients: [
    { label: 'Seafood mix', consensus: 'Mixed fish and shellfish (clams, shrimp, squid, fish)', percentage: 80 },
    { label: 'Tomatoes', consensus: 'Canned San Marzano, crushed', percentage: 78 },
    { label: 'Wine', consensus: 'Dry white wine', percentage: 82 },
    { label: 'Aromatics', consensus: 'Garlic, peperoncino, parsley', percentage: 85 },
    { label: 'Bread', consensus: 'Toasted garlic bread for serving', percentage: 80 },
  ],
  techniques: [
    { label: 'Seafood timing', consensus: 'Stagger additions by cook time', percentage: 85 },
    { label: 'Broth building', consensus: 'Build broth from shells and trimmings', percentage: 70, alternative: 'Start with fish stock', altPercentage: 30 },
    { label: 'Heat management', consensus: 'Gentle simmer to not toughen fish', percentage: 82 },
  ],
  differs: [],
},

'roasted-cauliflower-dy2dx9w9': {
  recipesAnalyzed: 16,
  sources: ['Serious Eats', 'NYT Cooking', 'Bon Appétit', 'Smitten Kitchen', 'Cookie and Kate'],
  ingredients: [
    { label: 'Cut style', consensus: 'Florets, large wedges', percentage: 72, alternative: 'Whole head roasted', altPercentage: 28 },
