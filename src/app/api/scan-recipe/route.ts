...
Return a single JSON object with exactly these fields:
{
  ...
  "summary": string (SKELETAL cooking arc — 3-5 comma-separated phrases, under 20 words, broad ingredient labels ("aromatics", "the meat"), no measurements or technique. e.g. "Season and sear chicken, add lemon and dates, braise until tender." / "Bloom aromatics, simmer sauce, add beans, finish with poached eggs."),
